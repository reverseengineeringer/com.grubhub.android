  ...
  extends View
{
  ...
  private Rect guideStrokeRect(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    bottom = (i + Math.max(paramInt2, paramInt4));
    return localRect;
  }
  ...
  public void setGuideAndRotation(Rect paramRect, int paramInt)
  {
    ...
    for (mRotationFlip = -1;; mRotationFlip = 1)
    {
      if (mCameraPreviewRect != null)
      {
        ...
        paramInt = mCameraPreviewRect.right;
        int i = x;
        int j = mCameraPreviewRect.top;
        mLogoRect = Util.rectGivenCenter(new Point(paramInt - i, y + j), (int)(100.0F * mScale), (int)(mScale * 50.0F));
