  ...
  extends Activity
{
  ...
  private void doOrientationChange(int paramInt)
  {
    ...
    int i = getRotationalOffset() + paramInt;
    if (i > 360) {
      i -= 360;
    }
    for (;;)
  ...
  {
    return new Date("03/10/2015 11:22:54 -0500");
  }
  ...
  private void setDeviceDegrees(int paramInt)
  {
    ...
    int i = bottom;
    bottom = (localSurfaceView.getTop() + i);
  ...
  private void setPreviewLayout()
  {
    ...
    for (;;)
    {
      ...
      i = (int)(getResourcesgetDisplayMetricsdensity * 15.0F + 0.5F);
