  ...
  implements Validator
{
  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt3 == 0) && (paramCharSequence.length() > 0) && ('1' < paramCharSequence.charAt(0)) && (paramCharSequence.charAt(0) <= '9'))
    {
    ...
    for (;;)
    {
      ...
      paramSpanned = new SpannableStringBuilder(paramSpanned).replace(paramInt3, paramInt4, paramCharSequence, paramInt1, i).toString();
