...
class Logo
{
  ...
  public void draw(Canvas paramCanvas, float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      paramFloat1 /= 2.0F;
      paramFloat2 /= 2.0F;
      paramCanvas.drawBitmap(mLogo, new Rect(0, 0, mLogo.getWidth(), mLogo.getHeight()), new RectF(-paramFloat1, -paramFloat2, paramFloat1, paramFloat2), mPaint);
      paramCanvas.restore();
      return;
      paramFloat2 = paramFloat1 * f;
    }
  }
