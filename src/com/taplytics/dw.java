  ...
  implements du
{
  ...
  public dw(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    if (paramHandler != null) {}
    for (h = new dx(this, paramHandler);; h = new dx(this))
    {
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    if ((i6 & 0xFF) == 6)
    {
      ...
      i3 = dz.a(paramMotionEvent);
      i5 = dz.b(paramMotionEvent);
      i4 = 0;
      f1 = 0.0F;
      f2 = 0.0F;
      label66:
    ...
    for (;;)
    {
      ...
      break label53;
      label101:
      f2 += dz.b(paramMotionEvent, i4);
      f1 += dz.c(paramMotionEvent, i4);
    }
    label122:
    if (i1 != 0)
    {
    ...
    case 2: 
      do
      {
        ...
        do
        {
          i1 += 1;
          break;
          i4 = dz.a(paramMotionEvent, i1);
          f3 = ee.a(x, i4);
        } while (ee.b(x, i4) * f2 + f3 * f1 >= 0.0F);
        x.clear();
        return false;
        if (j != null)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          i2 = dz.a(paramMotionEvent, 0);
          localVelocityTracker.computeCurrentVelocity(1000, d);
          f1 = ee.b(localVelocityTracker, i2);
          f2 = ee.a(localVelocityTracker, i2);
...
/* Location:
 * Qualified Name:     com.taplytics.dw
