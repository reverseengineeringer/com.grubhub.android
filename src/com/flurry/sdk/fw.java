  ...
  public Map<String, List<String>> a(String paramString)
  {
    ...
    if (i < j)
    {
      ...
      if (localObject2.length != 2) {
        ib.a(5, a, "Invalid referrer Element: " + str + " in referrer tag " + paramString);
      }
      for (;;)
      {
        i += 1;
    ...
    while (paramString.hasNext())
    {
      ...
      ib.a(3, a, "entry: " + (String)((Map.Entry)localObject1).getKey() + "=" + ((Map.Entry)localObject1).getValue());
    }
    ...
    if (paramString.length() > 0) {
      ib.a(5, a, "Detected missing referrer keys : " + paramString.toString());
    }
    return localHashMap;
  }
}
