...
public class jf
{
  ...
  private Map<String, List<jf.a>> b = new HashMap();
  ...
  private void b(String paramString, Object paramObject)
  {
    if (b.get(paramString) != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((jf.a)localIterator.next()).a(paramString, paramObject);
      }
    }
  }
  ...
  /* Error */
  public void a(String paramString, jf.a parama)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   15: ifnull -4 -> 11
    //   18: aload_0
    //   19: getfield 20	com/flurry/sdk/jf:b	Ljava/util/Map;
    //   22: aload_1
    ...
    //   59: pop
    //   60: aload_0
    //   61: getfield 20	com/flurry/sdk/jf:b	Ljava/util/Map;
    //   64: aload_1
    //   65: aload 4
  ...
  /* Error */
  public boolean b(String paramString, jf.a parama)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   23: goto -10 -> 13
    //   26: aload_0
    //   27: getfield 20	com/flurry/sdk/jf:b	Ljava/util/Map;
    //   30: aload_1
