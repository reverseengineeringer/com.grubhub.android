...
public class hp
{
  ...
  public void a(String paramString1, String arg2, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          ib.e(b, "MaxOriginParams exceeded: " + ((Map)localObject).size());
          return;
        }
  ...
  public HashMap<String, Map<String, String>> c()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 28	com/flurry/sdk/hp:c	Ljava/util/HashMap;
    //   5: astore_1
    //   6: aload_1
    //   7: monitorenter
    //   8: new 23	java/util/HashMap
    //   11: dup
    //   12: getstatic 28	com/flurry/sdk/hp:c	Ljava/util/HashMap;
