...
import com.grubhub.AppBaseLibrary.android.dataServices.dto.apiV2.V2DeliveryLookupDTO.GHSDeliveryDataModel;
...
import com.grubhub.AppBaseLibrary.android.dataServices.dto.apiV2.V2RestaurantAvailabilityDTO.V2RestaurantAvailabilitySummary;
...
import com.grubhub.AppBaseLibrary.android.dataServices.dto.apiV2.V2SavedAddressDTO;
  ...
  extends a
{
  ...
  {
    return (GHSIReviewsDataModel)a("com.grubhub.persistence.reviews", V2ReviewsDataModel.class);
  }
  
  public ArrayList<GHSIOrderReviewDataModel> M()
  {
    com.grubhub.AppBaseLibrary.android.utils.d.b((ArrayList)a("com.grubhub.persistence.orderReviews", new TypeToken() {}.getType()));
  }
  
  public GHSIUserAuthDataModel N()
  {
    return (GHSIUserAuthDataModel)a("com.grubhub.persistence.user", V2UserAuthDTO.class);
  }
  
  public GHSIUserAuthDataModel O()
  {
    return (GHSIUserAuthDataModel)a("com.grubhub.persistence.anonymousUser", V2UserAuthDTO.class);
  }
  
  public GHSIFoodMenuDataModel P()
  {
    return (GHSIFoodMenuDataModel)a("com.grubhub.persistence.foodMenu", V2RestaurantDTO.class);
  }
  ...
  {
    (ArrayList)a("com.grubhub.persistence.vaultedPayPals", new TypeToken() {}.getType());
  }
  
  public GHSIRestaurantDataModel T()
  {
    return (GHSIRestaurantDataModel)a("com.grubhub.persistence.searchedRestaurant", V2RestaurantDTO.class);
  }
  
  public GHSIRestaurantDataModel U()
  {
    return (GHSIRestaurantDataModel)a("com.grubhub.persistence.selectedRestaurant", V2RestaurantDTO.class);
  }
  
  public GHSIRestaurantDataModel V()
  {
    return (GHSIRestaurantDataModel)a("com.grubhub.persistence.receiptRestaurant", V2RestaurantDTO.class);
  }
  
  public GHSIRestaurantListDataModel W()
  {
    return (GHSIRestaurantListDataModel)a("com.grubhub.persistence.restaurantList", V2RestaurantListDTO.class);
  }
  
  public GHSICartDataModel X()
  {
    return (GHSICartDataModel)a("com.grubhub.persistence.cartData", V2CartDTO.class);
  }
  ...
  {
    return (GHSICartDataModel)a("com.grubhub.persistence.receipt", V2CartDTO.class);
  }
  
  protected String a()
  {
    return "V2SharedPreferences";
  }
  ...
  {
    a("com.grubhub.persistence.billData", paramGHSIBillModel);
  }
  ...
  {
    a("com.grubhub.persistence.message", paramGHSIMessage);
  }
  ...
  {
    a("com.grubhub.persistence.deliveryLookup", paramLinkedHashMap);
  }
  ...
  {
    return (GHSIPastOrderListDataModel)a("com.grubhub.persistence.pastOrders", V2OrderHistoryDTO.class);
  }
  
  public ArrayList<GHSSearchAutoValueDataModel> ac()
  {
    (ArrayList)a("com.grubhub.persistence.previousSearches", new TypeToken() {}.getType());
  }
  
  public ArrayList<GHSIRestaurantAvailabilityDataModel.GHSIRestaurantAvailabilitySummary> ad()
  {
    (ArrayList)a("com.grubhub.persistence.restaurantAvailabilties", new TypeToken() {}.getType());
  }
  
  public LinkedHashMap<String, GHSIDeliveryDataModel> ae()
  {
    (LinkedHashMap)a("com.grubhub.persistence.deliveryLookup", new TypeToken() {}.getType());
  }
  ...
  {
    a("com.grubhub.persistence.orderReviews", paramArrayList);
  }
  ...
  public void d(ArrayList<GHSIAddressDataModel> paramArrayList)
  {
    if ((paramArrayList != null) && (!paramArrayList.isEmpty()))
    {
      ...
      while (localIterator.hasNext()) {
        ((GHSIAddressDataModel)localIterator.next()).setDataModelVersion("V2");
      }
    }
  ...
  {
    a("com.grubhub.persistence.vaultedPayPals", paramArrayList);
  }
  
  public void f(ArrayList<GHSSearchAutoValueDataModel> paramArrayList)
  {
    a("com.grubhub.persistence.previousSearches", paramArrayList);
  }
  
  public void g(ArrayList<GHSIRestaurantAvailabilityDataModel.GHSIRestaurantAvailabilitySummary> paramArrayList)
  {
    a("com.grubhub.persistence.restaurantAvailabilties", paramArrayList);
  }
}

/* Location:
 * Qualified Name:     com.grubhub.AppBaseLibrary.android.dataServices.b.d
