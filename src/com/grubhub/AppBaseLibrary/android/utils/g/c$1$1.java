  ...
  implements h
{
  ...
  public void a(PaymentMethod paramPaymentMethod)
  {
    ...
    {
      return;
      com.grubhub.AppBaseLibrary.android.utils.e.a.b("Unable to retrieve PayPal payment nonce.", "Client token: " + a.a.getToken());
    } while (a.b.c == null);
...
/* Location:
 * Qualified Name:     com.grubhub.AppBaseLibrary.android.utils.g.c.1.1
