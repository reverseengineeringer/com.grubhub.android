  ...
  extends Fragment
{
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(al.com_facebook_login_fragment, paramViewGroup, false);
    b.a(new d()
    {
      public void a()
      {
        paramLayoutInflater.findViewById(ak.com_facebook_login_activity_progress_bar).setVisibility(0);
      }
      
      public void b()
      {
        paramLayoutInflater.findViewById(ak.com_facebook_login_activity_progress_bar).setVisibility(8);
      }
    });
  ...
  {
    super.onPause();
    getActivity().findViewById(ak.com_facebook_login_activity_progress_bar).setVisibility(8);
  }
