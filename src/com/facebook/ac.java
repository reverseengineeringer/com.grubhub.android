...
final class ac
{
  ...
  {
    ap.a(paramBundle, "bundle");
    return paramBundle.getString("com.facebook.TokenCachingStrategy.Token");
  }
  
  public static e c(Bundle paramBundle)
  {
    ap.a(paramBundle, "bundle");
    if (paramBundle.containsKey("com.facebook.TokenCachingStrategy.AccessTokenSource")) {
      return (e)paramBundle.getSerializable("com.facebook.TokenCachingStrategy.AccessTokenSource");
    }
  ...
  public Bundle a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        ab.a(ad.CACHE, 5, a, "Error reading cached value for key: '" + str + "' -- " + localJSONException);
        return null;
      }
    }
