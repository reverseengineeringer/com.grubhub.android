  ...
  implements t
{
  ...
  public v(OutputStream paramOutputStream, ab paramab, boolean paramBoolean)
  {
    a = paramOutputStream;
    b = paramab;
    d = paramBoolean;
    ...
    throws IOException
  {
    ...
    paramString2 = m.f().getContentResolver().openInputStream(paramUri);
    if ((a instanceof ag))
    {
      long l = al.a(paramUri);
      ((ag)a).a(l);
    }
    for (int i = 0;; i = al.a(paramString2, a) + 0)
    {
      b("", new Object[0]);
      a();
      if (b != null) {
    ...
    throws IOException
  {
    ...
    a(paramString1, paramString1, str);
    if ((a instanceof ag)) {
      ((ag)a).a(paramParcelFileDescriptor.getStatSize());
    }
    for (int i = 0;; i = al.a(new ParcelFileDescriptor.AutoCloseInputStream(paramParcelFileDescriptor), a) + 0)
    {
      b("", new Object[0]);
      a();
      if (b != null) {
