...
class k
{
  ...
  private Context b;
  private HashMap<b, List<d>> c = new HashMap();
  ...
  public static void a(Context paramContext, b paramb, l paraml)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put(paramb, paraml);
    a(paramContext, localHashMap);
  }
  
  public static void a(Context paramContext, Map<b, l> paramMap)
  {
    synchronized (a)
    {
      ...
      while (paramMap.hasNext())
      {
        ...
        List localList = ((l)localEntry.getValue()).b();
        if (localList.size() != 0) {
          paramContext.a((b)localEntry.getKey(), localList);
        }
      }
    }
    paramContext.b();
  ...
  {
    // Byte code:
    //   0: new 96	java/io/ObjectOutputStream
    //   3: dup
    //   4: new 98	java/io/BufferedOutputStream
    //   7: dup
    //   8: aload_0
    //   9: getfield 27	com/facebook/a/k:b	Landroid/content/Context;
    //   12: ldc 100
    //   14: iconst_0
    //   15: invokevirtual 106	android/content/Context:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   18: invokespecial 109	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   21: invokespecial 110	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   24: astore_2
    //   25: aload_2
    //   26: astore_1
    //   27: aload_2
    //   28: aload_0
    //   29: getfield 25	com/facebook/a/k:c	Ljava/util/HashMap;
    //   32: invokevirtual 114	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   35: aload_2
    //   36: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   39: return
    //   40: astore_3
    //   41: aconst_null
    //   42: astore_2
    //   43: aload_2
    //   44: astore_1
    //   45: invokestatic 125	com/facebook/a/a:f	()Ljava/lang/String;
    ...
    //   73: pop
    //   74: aload_2
    //   75: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   78: return
    //   79: astore_2
    //   80: aconst_null
    //   81: astore_1
    //   82: aload_1
    //   83: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   86: aload_2
    //   87: athrow
    //   88: astore_2
    //   89: goto -7 -> 82
  ...
  private void c()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 27	com/facebook/a/k:b	Landroid/content/Context;
    //   14: ldc 100
    ...
    //   32: checkcast 22	java/util/HashMap
    //   35: astore_3
    //   36: aload_1
    //   37: astore_2
    //   38: aload_0
    //   39: getfield 27	com/facebook/a/k:b	Landroid/content/Context;
    //   42: ldc 100
    ...
    //   53: aload_0
    //   54: aload_3
    //   55: putfield 25	com/facebook/a/k:c	Ljava/util/HashMap;
    //   58: aload_1
    //   59: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   62: return
    //   63: astore_1
    //   64: aload_2
    //   65: astore_1
    //   66: aload_1
    //   67: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   70: return
    //   71: astore_3
    //   72: aconst_null
    //   73: astore_1
    //   74: aload_1
    //   75: astore_2
    //   76: invokestatic 125	com/facebook/a/a:f	()Ljava/lang/String;
    ...
    //   104: pop
    //   105: aload_1
    //   106: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   109: return
    //   110: astore_1
    //   111: aconst_null
    //   112: astore_2
    //   113: aload_2
    //   114: invokestatic 119	com/facebook/internal/al:a	(Ljava/io/Closeable;)V
    //   117: aload_1
    //   118: athrow
    //   119: astore_1
    //   120: goto -7 -> 113
  ...
  public void a(b paramb, List<d> paramList)
  {
    if (!c.containsKey(paramb)) {
      c.put(paramb, new ArrayList());
    }
    ((List)c.get(paramb)).addAll(paramList);
  }
}

/* Location:
 * Qualified Name:     com.facebook.a.k
