...
final class y
{
    ...
    throws IOException
  {
    ...
    while (i < 3)
    {
      ...
      if (m == -1)
      {
        ab.a(ad.CACHE, s.a, "readHeader: stream.read returned -1 while reading header size");
        return null;
      }
      j = (j << 8) + (m & 0xFF);
      i += 1;
    ...
    while (i < arrayOfByte.length)
    {
      ...
      if (j < 1)
      {
        ab.a(ad.CACHE, s.a, "readHeader: stream.read stopped at " + Integer.valueOf(i) + " when expected " + arrayOfByte.length);
        return null;
      }
      i += j;
    }
    ...
    try
    {
      ...
      {
        ab.a(ad.CACHE, s.a, "readHeader: expected JSONObject, got " + paramInputStream.getClass().getCanonicalName());
        return null;
      }
...
/* Location:
 * Qualified Name:     com.facebook.internal.y
