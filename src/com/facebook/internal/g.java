...
public class g
{
  private static final Map<Class<?>, h> a = new HashMap();
    ...
    throws JSONException
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject != null) && (localObject != JSONObject.NULL)) {
        ...
        {
          h localh = (h)a.get(localObject.getClass());
          if (localh == null) {
    ...
    throws JSONException
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localObject1 != null)
      {
        ...
        {
          localObject2 = (h)a.get(localObject1.getClass());
          if (localObject2 == null) {
            throw new IllegalArgumentException("Unsupported type: " + localObject1.getClass());
          }
          ((h)localObject2).a(localJSONObject, str, localObject1);
        }
      }
    }
