  ...
  implements Parcelable
{
  ...
  private static final e d = e.FACEBOOK_APPLICATION_WEB;
  ...
  AccessToken(Parcel paramParcel)
  {
    ...
    i = e.valueOf(paramParcel.readString());
    j = new Date(paramParcel.readLong());
    k = paramParcel.readString();
    l = paramParcel.readString();
  }
  
  public AccessToken(String paramString1, String paramString2, String paramString3, Collection<String> paramCollection1, Collection<String> paramCollection2, e parame, Date paramDate1, Date paramDate2)
  {
    ap.a(paramString1, "accessToken");
    ap.a(paramString2, "applicationId");
    ap.a(paramString3, "userId");
    if (paramDate1 != null)
    {
      e = paramDate1;
  ...
  static AccessToken a(Bundle paramBundle)
  {
    ...
    String str2 = ac.d(paramBundle);
    String str1 = str2;
    if (al.a(str2)) {
      str1 = m.i();
    }
    str2 = ac.b(paramBundle);
    Object localObject = al.e(str2);
    try
    {
      localObject = ((JSONObject)localObject).getString("id");
      return new AccessToken(str2, str1, (String)localObject, localList1, localList2, ac.c(paramBundle), ac.a(paramBundle, "com.facebook.TokenCachingStrategy.ExpirationDate"), ac.a(paramBundle, "com.facebook.TokenCachingStrategy.LastRefreshDate"));
    }
    ...
    throws JSONException
  {
    ...
    e locale = e.valueOf(paramJSONObject.getString("source"));
    return new AccessToken(str, paramJSONObject.getString("application_id"), paramJSONObject.getString("user_id"), al.a(localJSONArray1), al.a(localJSONArray2), locale, localDate1, localDate2);
  }
