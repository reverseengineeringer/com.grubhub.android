...
public class a
{
  ...
  public void a(Context paramContext)
  {
    ...
    {
      Log.i("AppsFlyer_1.16", "Could not create cache directory");
    }
  }
  ...
  public void a(b paramb, Context paramContext)
  {
    try
    {
      ...
      {
        Log.i("AppsFlyer_1.16", "reached cache limit, not caching request");
        return;
      }
    }
    catch (Exception paramb)
    {
      Log.i("AppsFlyer_1.16", "Could not cache request");
      return;
    }
    Log.i("AppsFlyer_1.16", "caching request...");
  ...
  public void a(String paramString, Context paramContext)
  {
    ...
    Log.i("AppsFlyer_1.16", "Deleting " + paramString + " from cache");
    ...
    {
      Log.i("AppsFlyer_1.16", "Could not delete " + paramString + " from cache", paramContext);
    }
  }
  ...
  public List<b> b(Context paramContext)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ...
        Log.i("AppsFlyer_1.16", "Found cached request" + localFile.getName());
...
/* Location:
 * Qualified Name:     com.appsflyer.a.a
