  ...
  extends BroadcastReceiver
{
  ...
  {
    Log.i("AppsFlyer_1.16", "MultipleInstallBroadcastReceiver called");
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        Log.i("AppsFlyer_1.16", "trigger onReceive: class: " + activityInfo.name);
        try
        {
        ...
        {
          Log.e("AppsFlyer_1.16", "error in BroadcastReceiver " + activityInfo.name, localThrowable);
        }
      }
    }
