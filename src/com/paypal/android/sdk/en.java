...
public final class en
{
  ...
  public en(Context paramContext)
  {
    ...
    while (m < 10)
    {
      ...
      localTextView.setTextColor(eb.i);
      localTextView.setLinkTextColor(eb.p);
      localTextView.setTypeface(eb.o);
      localTextView.setTextSize(18.0F);
      localTextView.setSingleLine(false);
      localTextView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(localTextView);
      ec.a(localTextView, -1, -2);
      ec.a(localTextView, null, "10dip");
    ...
    ec.a(e, -1, -2);
    ec.b(e, null, "20dip", null, "10dip");
    e.setVisibility(8);
    h = ec.a(paramContext, true, 1, localLinearLayout);
    ...
    ec.b(g, null, null, null, "16dip");
    ec.a(g, -2, -2);
    ec.a(g, 17, 1.0F);
    g.setNextFocusLeftId(1);
    f = new eo(paramContext);
    k.addView(f.a);
    ec.a(f.a, -2, -2);
    ec.a(f.a, 17, 1.0F);
    a = j;
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.en
