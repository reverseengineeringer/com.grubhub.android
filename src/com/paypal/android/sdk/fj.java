  ...
  extends dy
{
  ...
  public fj(ea paramea, ef paramef, String paramString1, String paramString2, String paramString3)
  {
    super(localee, paramea, paramef, str, "/" + paramString3);
    ...
    if (paramJSONArray != null)
    {
      ...
      while (i < paramJSONArray.length())
      {
        ...
        if (localObject != null)
        {
          ...
          if ((ft.c(str)) && (ft.c((CharSequence)localObject))) {
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.fj
