  ...
  implements fz
{
  ...
  public gk()
  {
    a.put(em.a, "Accetta e paga");
    a.put(em.b, "e altri");
    a.put(em.c, "Autenticazione…");
    a.put(em.d, "Prec.");
    a.put(em.e, "Di riserva");
    a.put(em.f, "Annulla");
    a.put(em.g, "American Express");
    a.put(em.h, "Carta Aura");
    a.put(em.i, "Carta Aurore");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Modifica metodo di pagamento");
    a.put(em.x, "Conto corrente");
    a.put(em.y, "Controllo dispositivo…");
    a.put(em.z, "Rimuovi dati della carta");
    a.put(em.A, "Conferma");
    a.put(em.B, "Rimuovere i dati della carta?");
    a.put(em.C, "Addebita importo sulla carta");
    a.put(em.D, "Vuoi uscire da PayPal?");
    a.put(em.E, "Paga");
    a.put(em.F, "Accetta");
    a.put(em.G, "Data creazione conto");
    a.put(em.H, "Stato del conto");
    a.put(em.I, "Tipo di conto");
    a.put(em.J, "Indirizzo");
    a.put(em.K, "Fascia di età");
    a.put(em.L, "Data di nascita");
    a.put(em.M, "Indirizzo email");
    a.put(em.N, "Nome e cognome");
    a.put(em.O, "Sesso");
    a.put(em.P, "Lingua");
    a.put(em.Q, "Locale");
    a.put(em.R, "Telefono");
    a.put(em.S, "Fuso orario");
    a.put(em.T, "Condividi il seguente: %s.");
    a.put(em.U, "Usa Pagamento express.");
    a.put(em.V, "%s ti chiede di:");
    a.put(em.W, "Condividi i <a href='%1$s'>metodi di pagamento</a> collegati al tuo conto PayPal.");
    a.put(em.X, "Per effettuare una scelta, attiva la visualizzazione dei metodi di pagamento.");
    a.put(em.Y, "<a href='%1$s'>Autorizza l’addebito</a> dei prossimi acquisti effettuati su %2$s e pagati con PayPal. Autorizzi PayPal a pagare tutti gli importi richiesti da %3$s.");
    a.put(em.Z, "consentirgli di aggiungere e gestire la propria carta fedeltà nel tuo portafoglio PayPal.");
    a.put(em.aa, "Accettare l’<a href='%2$s'></a> Informativa sulla privacy<a href='%3$s'> e le</a> Condizioni d’uso di %1$s.");
    a.put(em.ab, "Consentirgli di <a href='%1$s'>richiedere denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(em.ac, "Consentirgli di <a href='%1$s'>inviare denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(em.ad, "Consenso");
    a.put(em.ae, "Email");
    a.put(em.af, "Dati di esempio");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "Scadenza");
    a.put(em.ai, "<h1><strong>Metodi di pagamento</strong></h1><p>PayPal condivide solo i tuoi metodi di pagamento disponibili per l’utilizzo.</p>");
    a.put(em.aj, "Password dimenticata?");
    a.put(em.ak, "Da");
    a.put(em.al, "Come vuoi pagare i prossimi acquisti su %1$s?");
    a.put(em.am, "<h1><strong>Consenso ai pagamenti preautorizzati</strong></h1><p>Gli importi dei prossimi pagamenti effettuati con PayPal da questa app verranno prelevati dal tuo metodo di pagamento predefinito.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona <strong>Profilo</strong> &gt; <strong>Sicurezza</strong> &gt; <strong>Log in con PayPal</strong> e rimuovi il commerciante dall’elenco.</p><p>Si applica la sezione Pagamenti automatici delle <a href='%s'>Condizioni d’uso PayPal</a>.</p><p>Per verificare il funzionamento dell’addebito dei pagamenti futuri sul tuo conto PayPal, questa app potrebbe simulare una transazione di prova, senza un reale trasferimento di denaro.</p>");
    a.put(em.an, "Errore interno");
    a.put(em.ao, "<p>Cliccando il pulsante di seguito, accetto le <a href='%1$s'>Condizioni d’uso PayPal</a> e dichiaro di rispettare le leggi e normative del Giappone, tra cui le sanzioni previste per i pagamenti alla Corea del Nord e all’Iran in base al <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> (Legge sugli scambi e sul commercio estero), per completare la transazione.</p>");
    a.put(em.ap, "Accedi");
    a.put(em.aq, "Log in con PayPal");
    a.put(em.ar, "Esci");
    a.put(em.as, "Esci");
    a.put(em.at, "OK");
    a.put(em.au, "Password");
    a.put(em.av, "Paga dopo la consegna");
    a.put(em.aw, "Paga con");
    a.put(em.ax, "Paga con una carta");
    a.put(em.ay, "Saldo PayPal");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Telefono");
    a.put(em.aB, "PIN");
    a.put(em.aC, "Metodo di pagamento preferito");
    a.put(em.aD, "PayPal protegge la tua <a href='%s'>privacy</a> e i tuoi dati.");
    a.put(em.aE, "Elaborazione in corso");
    a.put(em.aF, "Ricorda dati carta");
    a.put(em.aG, "Richiedi denaro");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Tutti i dettagli rilevanti della transazione verranno condivisi con il commerciante.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona l’icona <strong>Profilo</strong> &gt; Sicurezza &gt; <strong>Log in con PayPal</strong> e rimuovi questo commerciante.</p><p>PayPal non è responsabile di azioni o errori da parte del Partner.</p>");
    a.put(em.aI, "Conto corrente");
    a.put(em.aJ, "Invia denaro");
    a.put(em.aK, "Si è verificato un problema con i nostri server. Riprova.");
    a.put(em.aL, "Ripeti l’accesso a PayPal.");
    a.put(em.aM, "Sessione scaduta");
    a.put(em.aN, "Indirizzo di spedizione");
    a.put(em.aO, "Non hai un conto PayPal? Registrati");
    a.put(em.aP, "Rimani collegato");
    a.put(em.aQ, "Errore di sistema (%s). Riprova più tardi.");
    a.put(em.aR, "Riprova");
    a.put(em.aS, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione.");
    a.put(em.aT, "Codice di sicurezza");
    a.put(em.aU, "Ricevi un SMS sul tuo telefono. Il codice a 6 cifre sarà valido per 5 minuti.");
    a.put(em.aV, "Invio SMS in corso");
    a.put(em.aW, "Immetti il codice di sicurezza a 6 cifre");
    a.put(em.aX, "Numero di cellulare");
    a.put(em.aY, "Ricevi SMS");
    a.put(em.aZ, "Ricevi un altro SMS");
    a.put(em.ba, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione. Visita il sito PayPal per attivare la chiave di accesso.");
    a.put(em.bb, "Pagamenti da questo dispositivo non consentiti.");
    a.put(em.bc, "Dispositivo non autorizzato");
    a.put(em.bd, "I pagamenti a questo venditore non sono consentiti (clientId non valido).");
    a.put(em.be, "Sito non valido");
    a.put(em.bf, "Si è verificato un problema durante l’elaborazione del pagamento. Riprova.");
    a.put(em.bg, "Metodo non riconosciuto");
    a.put(em.bh, "Spiacenti");
    a.put(em.bi, "Il tuo ordine");
    a.put(em.bj, "Rimuovere la carta?");
    a.put(em.bk, "Consenso non riuscito");
    a.put(em.bl, "Connessione non riuscita");
    a.put(em.bm, "Accesso non riuscito");
    a.put(em.bn, "Accedi con la password");
    a.put(em.bo, "Accedi con il PIN");
    a.put(em.bp, "Attendi…");
    a.put(em.bq, "Pagamento non riuscito");
    a.put(em.br, "Scansione");
    a.put(em.bs, "Codice di sicurezza errato. Riprova.");
    a.put(em.bt, "tramite");
    a.put(em.bu, "Errore di sistema. Riprova più tardi.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gk
