  ...
  implements fz
{
  ...
  public gf()
  {
    a.put(em.a, "Agree and Pay");
    a.put(em.b, "& other");
    a.put(em.c, "Authenticating");
    a.put(em.d, "Back");
    a.put(em.e, "Backup");
    a.put(em.f, "Cancel");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Change Funding Source");
    a.put(em.x, "Current");
    a.put(em.y, "Checking this device…");
    a.put(em.z, "Clear card details");
    a.put(em.A, "Confirm");
    a.put(em.B, "Are you sure you want to clear your card details?");
    a.put(em.C, "Charge Card");
    a.put(em.D, "Are you sure you want to log out of PayPal?");
    a.put(em.E, "Pay");
    a.put(em.F, "Agree");
    a.put(em.G, "Account Creation Date");
    a.put(em.H, "Account Status");
    a.put(em.I, "Account Type");
    a.put(em.J, "Address Line 1");
    a.put(em.K, "Age Range");
    a.put(em.L, "Date of Birth");
    a.put(em.M, "Email Address");
    a.put(em.N, "Full Name");
    a.put(em.O, "Gender");
    a.put(em.P, "Language");
    a.put(em.Q, "Locale");
    a.put(em.R, "Phone Number");
    a.put(em.S, "Time Zone");
    a.put(em.T, "Share the following: %s.");
    a.put(em.U, "Use Seamless Checkout.");
    a.put(em.V, "%s asks that you:");
    a.put(em.W, "Share the <a href='%1$s'>funding sources</a> linked to your PayPal account.");
    a.put(em.X, "Enable the display of your funding options to allow you to make a choice.");
    a.put(em.Y, "<a href='%1$s'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    a.put(em.Z, "Allow them to add and manage their loyalty card in your PayPal wallet.");
    a.put(em.aa, "Agree to the %1$s <a href='%2$s'>privacy policy</a> and <a href='%3$s'>user agreement</a>");
    a.put(em.ab, "Permit them to <a href='%1$s'>request money</a> on your behalf until you withdraw consent.");
    a.put(em.ac, "Permit them to <a href='%1$s'>send money</a> on your behalf until you withdraw consent.");
    a.put(em.ad, "Consent");
    a.put(em.ae, "Email");
    a.put(em.af, "Mock Data");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "Expires");
    a.put(em.ai, "<h1><strong>Funding Sources</strong></h1><p>PayPal only shares which of your funding sources are available for use.</p>");
    a.put(em.aj, "Forgotten your password?");
    a.put(em.ak, "From");
    a.put(em.al, "How would you like to fund future payments to %1$s?");
    a.put(em.am, "<h1><strong>Future Payment Agreement</strong></h1><p>Your default funding source will be used to pay for future PayPal payments from this merchant.</p><p>To cancel this agreement, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>The Recurring Payment section of the <a href='%s'>PayPal User Agreement</a> shall apply.</p><p>To make sure payments work with your PayPal account, this app may simulate a small test transaction, but no money will be transferred for this.</p>");
    a.put(em.an, "Internal Error");
    a.put(em.ao, "<p>By clicking the button below, I hereby agree to the terms of the <a href='%1$s'>PayPal User Agreement</a> and declare that I am in compliance with Japanese laws and regulations, including sanctions against payments to North Korea and Iran pursuant to the <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> to complete the transaction.</p>");
    a.put(em.ap, "Log In");
    a.put(em.aq, "Log In with PayPal");
    a.put(em.ar, "Log Out");
    a.put(em.as, "Log out");
    a.put(em.at, "OK");
    a.put(em.au, "Password");
    a.put(em.av, "Pay After Delivery");
    a.put(em.aw, "Pay with");
    a.put(em.ax, "Pay with Card");
    a.put(em.ay, "PayPal Balance");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Phone");
    a.put(em.aB, "PIN");
    a.put(em.aC, "Preferred Funding Source");
    a.put(em.aD, "PayPal protects your <a href='%s'>privacy</a> and financial information.");
    a.put(em.aE, "Processing");
    a.put(em.aF, "Remember card");
    a.put(em.aG, "Request Money");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Any relevant transaction details will be shared with the merchant.</p><p>To withdraw consent, log in at paypal.com then go to <strong>Log In with PayPal</strong> options under <strong>Profile</strong> settings and remove this merchant.</p><p>PayPal is not responsible for any actions or errors on the part of the partner.</p>");
    a.put(em.aI, "Savings");
    a.put(em.aJ, "Send Money");
    a.put(em.aK, "There was a problem communicating with the PayPal servers. Please try again.");
    a.put(em.aL, "Please log in to PayPal again.");
    a.put(em.aM, "Session Expired");
    a.put(em.aN, "Delivery Address");
    a.put(em.aO, "New to PayPal? Sign Up");
    a.put(em.aP, "Stay logged in");
    a.put(em.aQ, "System error (%s). Please try again later.");
    a.put(em.aR, "Try Again");
    a.put(em.aS, "Unable to log in because two-factor authentication has been enabled for your account.");
    a.put(em.aT, "Verification Code");
    a.put(em.aU, "Send a text message to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(em.aV, "Sending Text");
    a.put(em.aW, "Enter the 6-digit verification code");
    a.put(em.aX, "Your mobile number");
    a.put(em.aY, "Send Text");
    a.put(em.aZ, "Send Text Again");
    a.put(em.ba, "Unable to log in because two-factor authentication has been enabled for your account. Please visit the PayPal website to activate your security key.");
    a.put(em.bb, "Payments from this device are not allowed.");
    a.put(em.bc, "Unauthorised Device");
    a.put(em.bd, "Payments to this merchant are not allowed (invalid clientId).");
    a.put(em.be, "Invalid merchant");
    a.put(em.bf, "There was a problem processing your payment. Please try again.");
    a.put(em.bg, "Unrecognised Source");
    a.put(em.bh, "We’re Sorry");
    a.put(em.bi, "Your Order");
    a.put(em.bj, "Clear Card?");
    a.put(em.bk, "Consent Failed");
    a.put(em.bl, "Connection Failed");
    a.put(em.bm, "Login Failed");
    a.put(em.bn, "Log in with password");
    a.put(em.bo, "Log in with PIN");
    a.put(em.bp, "One moment…");
    a.put(em.bq, "Payment Failed");
    a.put(em.br, "Scan");
    a.put(em.bs, "Incorrect Security code. Please try again.");
    a.put(em.bt, "Via");
    a.put(em.bu, "System error. Please try again later.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gf
