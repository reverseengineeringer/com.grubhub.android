  ...
  implements fz
{
  ...
  public f()
  {
    a.put(em.a, "Согласиться и оплатить");
    a.put(em.b, "и прочие");
    a.put(em.c, "Аутентификация");
    a.put(em.d, "Назад");
    a.put(em.e, "Резервный");
    a.put(em.f, "Отмена");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Изменить способ оплаты");
    a.put(em.x, "Проверка");
    a.put(em.y, "Выполняется проверка устройства…");
    a.put(em.z, "Очистить данные карты");
    a.put(em.A, "Подтвердить");
    a.put(em.B, "Вы уверены, что хотите очистить сведения о банковской карте?");
    a.put(em.C, "Оплатить по карте");
    a.put(em.D, "Выйти из учетной записи PayPal?");
    a.put(em.E, "Оплатить");
    a.put(em.F, "Соглашаюсь");
    a.put(em.G, "Дата создания счета");
    a.put(em.H, "Статус счета");
    a.put(em.I, "Тип счета");
    a.put(em.J, "Адрес");
    a.put(em.K, "Возрастной диапазон");
    a.put(em.L, "Дата рождения");
    a.put(em.M, "Эл. почта");
    a.put(em.N, "Полное имя");
    a.put(em.O, "Пол");
    a.put(em.P, "Язык");
    a.put(em.Q, "Локаль");
    a.put(em.R, "Телефон");
    a.put(em.S, "Часовой пояс");
    a.put(em.T, "Использовать совместно: %s.");
    a.put(em.U, "Воспользуйтесь безупречным способом оформления заказа.");
    a.put(em.V, "%s просит вашего разрешения:");
    a.put(em.W, "Поделиться информацией о <a href='%1$s'>способах оплаты</a>, привязанных к вашему счету PayPal.");
    a.put(em.X, "Включите отображение ваших источников средств, чтобы вы могли выбирать при совершении покупок.");
    a.put(em.Y, "<a href='%1$s'>Подтвердите списания</a> за будущие покупки через PayPal у продавца %2$s. Вы разрешаете PayPal оплачивать все суммы, запрашиваемые %3$s.");
    a.put(em.Z, "подключать и управлять дисконтными картами через ваш счет PayPal.");
    a.put(em.aa, "Подтвердить согласие с положениями %1$s <a href='%2$s'>Политики конфиденциальности</a> и <a href='%3$s'>Соглашения с пользователем</a>.");
    a.put(em.ab, "Разрешить им <a href='%1$s'>запрашивать денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(em.ac, "Разрешить им <a href='%1$s'>отправлять денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(em.ad, "Согласиться");
    a.put(em.ae, "Эл. почта");
    a.put(em.af, "Ложные данные");
    a.put(em.ag, "Изолированная программная среда");
    a.put(em.ah, "Действует до");
    a.put(em.ai, "<h1><strong>Способы оплаты</strong></h1><p>PayPal делится информацией только о том, какой из ваших способов оплаты доступен для использования.</p>");
    a.put(em.aj, "Забыли пароль?");
    a.put(em.ak, "С");
    a.put(em.al, "Какой источник средств предпочтительнее для будущих платежей пользователю %1$s?");
    a.put(em.am, "<h1><strong>Соглашение о будущих платежах</strong></h1><p>Для всех будущих платежей через PayPal этот продавец будет использовать ваш источник средств по умолчанию.</p><p>Для отмены данного соглашения войдите в систему PayPal под своим именем и перейдите по вкладке <strong>Профиль</strong> &gt; <strong>Мои настройки</strong> &gt; <strong>Войти через PayPal</strong> и удалите этого продавца из списка.</p><p>Будут применены условия раздела о регулярных платежах <a href='%s'>Соглашения с пользователем в отношении услуг PayPal</a>.</p><p>Для проверки работоспособности вашего счета PayPal это приложение может выполнить небольшую тестовую операцию без снятия или перевода денег.</p>");
    a.put(em.an, "Внутренняя ошибка");
    a.put(em.ao, "<p>Нажимая кнопку ниже, я подтверждаю свое согласие с условиями <a href='%1$s'>Соглашения с пользователем в отношении услуг PayPal</a> и заявляю, что, совершая данную финансовую операцию, действую в соответствии с действующим законодательством Японии, включая санкции в отношении перевода платежей в Северную Корею и Иран в рамках <a href='%2$s'>Закона об обмене валют и зарубежной торговле</a>.</p>");
    a.put(em.ap, "Вход");
    a.put(em.aq, "Вход с помощью учетной записи PayPal");
    a.put(em.ar, "Выход");
    a.put(em.as, "Выход");
    a.put(em.at, "ОК");
    a.put(em.au, "Пароль");
    a.put(em.av, "Оплата после доставки");
    a.put(em.aw, "Способ оплаты:");
    a.put(em.ax, "Оплатить картой");
    a.put(em.ay, "На счете PayPal");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Телефон");
    a.put(em.aB, "PIN-код");
    a.put(em.aC, "Предпочтительный способ оплаты");
    a.put(em.aD, "PayPal гарантирует защиту ваших <a href='%s'>конфиденциальных данных</a> и финансовой информации.");
    a.put(em.aE, "Выполняется обработка");
    a.put(em.aF, "Запомнить карту");
    a.put(em.aG, "Запросить средства");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Любые сведения, относящиеся к операции, будут переданы продавцу.</p><p>Для отмены согласия зайдите на сайт paypal.com, выберите <strong>Войти через PayPal</strong> в разделе <strong>Профиль</strong> и удалите данного продавца.</p><p>Компания PayPal не несет ответственности за действия или ошибки со стороны продавца.</p>");
    a.put(em.aI, "Сберегательный");
    a.put(em.aJ, "Отпр. средства");
    a.put(em.aK, "Была проблема связи с серверами PayPal. Повторите попытку.");
    a.put(em.aL, "Войдите в учетную запись PayPal заново.");
    a.put(em.aM, "Ваш сеанс истек");
    a.put(em.aN, "Адрес доставки");
    a.put(em.aO, "Впервые в PayPal? Зарегистрироваться");
    a.put(em.aP, "Не выходить из системы");
    a.put(em.aQ, "Системная ошибка (%s). Повторите попытку позже.");
    a.put(em.aR, "Повторить");
    a.put(em.aS, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации.");
    a.put(em.aT, "Код безопасности карты");
    a.put(em.aU, "Отправьте SMS-сообщение на свой номер телефона. 6-значный код, который вы получили, будет действителен в течение 5 минут.");
    a.put(em.aV, "Отправка SMS-сообщения");
    a.put(em.aW, "Введите 6-значный код безопасности");
    a.put(em.aX, "Номер вашего мобильного телефона");
    a.put(em.aY, "Отправить SMS-сообщение");
    a.put(em.aZ, "Отправить SMS-сообщение еще раз");
    a.put(em.ba, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации. Войдите на веб-сайт PayPal, чтобы активировать ваш ключ безопасности.");
    a.put(em.bb, "Платежи через данное устройство запрещены.");
    a.put(em.bc, "Неавторизованное устройство");
    a.put(em.bd, "Платежи данному продавцу не разрешены (недействительный код клиента).");
    a.put(em.be, "Недействительный продавец");
    a.put(em.bf, "При обработке платежа произошла ошибка. Повторите попытку.");
    a.put(em.bg, "Нераспознанный источник");
    a.put(em.bh, "Приносим извинения");
    a.put(em.bi, "Ваш заказ");
    a.put(em.bj, "Очистить данные карты?");
    a.put(em.bk, "Не удалось подтвердить согласие");
    a.put(em.bl, "Соединение не выполнено");
    a.put(em.bm, "Не удалось войти в систему");
    a.put(em.bn, "Войдите в систему при помощи пароля");
    a.put(em.bo, "Войдите в систему при помощи PIN-кода");
    a.put(em.bp, "Минуточку…");
    a.put(em.bq, "Не удалось выполнить платеж");
    a.put(em.br, "Сканирование");
    a.put(em.bs, "Неправильный код безопасности. Повторите попытку.");
    a.put(em.bt, "через");
    a.put(em.bu, "Системная ошибка. Повторите попытку позже.");
