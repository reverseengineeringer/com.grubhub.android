  ...
  implements fz
{
  ...
  public ga()
  {
    a.put(em.a, "الموافقة والدفع");
    a.put(em.b, "وغير ذلك");
    a.put(em.c, "جارِ المصادقة");
    a.put(em.d, "عودة");
    a.put(em.e, "الاحتياطية");
    a.put(em.f, "إلغاء");
    ...
    a.put(em.v, "Visa‏");
    a.put(em.w, "تغيير طريقة الدفع");
    a.put(em.x, "حساب جاري");
    a.put(em.y, "جار فحص هذا الجهاز…");
    a.put(em.z, "مسح معلومات البطاقة");
    a.put(em.A, "تأكيد");
    a.put(em.B, "هل تريد بالفعل مسح معلومات بطاقتك؟");
    a.put(em.C, "بطاقة الدفع الآجل");
    a.put(em.D, "هل تريد بالفعل تسجيل الخروج من باي بال؟");
    a.put(em.E, "دفع");
    a.put(em.F, "موافقة");
    a.put(em.G, "تاريخ إنشاء الحساب");
    a.put(em.H, "حالة الحساب");
    a.put(em.I, "نوع الحساب");
    a.put(em.J, "العنوان");
    a.put(em.K, "الفئة العمرية");
    a.put(em.L, "تاريخ الميلاد");
    a.put(em.M, "عنوان البريد الإلكتروني");
    a.put(em.N, "الاسم بالكامل");
    a.put(em.O, "الجنس");
    a.put(em.P, "اللغة");
    a.put(em.Q, "اللغة المحلية");
    a.put(em.R, "الهاتف");
    a.put(em.S, "المنطقة الزمنية");
    a.put(em.T, "مشاركة ما يلي: ‎%s‎‏.");
    a.put(em.U, "تمتع بسلاسة الدفع مع خدمة السداد السريع.");
    a.put(em.V, "%s يطلب منك:");
    a.put(em.W, "مشاركة <a href='%1$s'>طرق الدفع</a> المربوطة بحسابك على باي بال.");
    a.put(em.X, "قم بتفعيل عرض خيارات التمويل الخاصة بك لتتمكن من الاختيار بينها.");
    a.put(em.Y, "<a href='%1$s'>تفويض المدفوعات</a> مقابل مشتريات ‎%2$s‎ المستقبلية المسددة قيمتها بواسطة باي بال. أنت تُكلف باي بال بإجراء جميع المدفوعات التي يطلبها ‎%3$s‎‏.");
    a.put(em.Z, "السماح له بإضافة بطاقة الولاء الخاصه به في محفظتك على بال بال وإداراتها.");
    a.put(em.aa, "الموافقة على <a href='%2$s'>سياسة الخصوصية</a> و<a href='%3$s'>اتفاقية المستخدم</a> %1$s‏.");
    a.put(em.ab, "اسمح لهم <a href='%1$s'>بطلب تحويل الأموال</a> نيابةً عنك إلى أن تسحب موافقتك.");
    a.put(em.ac, "اسمح لهم <a href='%1$s'>بإرسال الأموال</a> نيابةً عنك إلى أن تسحب موافقتك.");
    a.put(em.ad, "قبول");
    a.put(em.ae, "البريد الإلكتروني");
    a.put(em.af, "بيانات صورية");
    a.put(em.ag, "آلية الاختبار Sandbox‏");
    a.put(em.ah, "تاريخ انتهاء الصلاحية");
    a.put(em.ai, "<h1><strong>طرق الدفع</strong></h1><p>لا يشارك باي بال إلا طرق الدفع المتاحة للاستخدام.</p>");
    a.put(em.aj, "هل نسيت كلمة المرور؟");
    a.put(em.ak, "مِن");
    a.put(em.al, "كيف ترغب في تمويل المدفوعات المستقبلية إلى %1$s‏؟");
    a.put(em.am, "<h1><strong>اتفاقية المدفوعات المستقبلية</strong></h1><p>سيُستخدم مصدر التمويل الافتراضي لديك لسداد مدفوعات باي بال المستقبلية من هذا التاجر.</p><p>لإلغاء هذه الاتفاقية، سجِّل الدخول إلى حسابك على باي بال، وانتقل إلى <strong>الملف الشخصي</strong> ثم <strong>إعداداتي</strong> ثم <strong>تسجيل الدخول مع باي بال</strong>، واحذف هذا التاجر من القائمة.تنطبق بنود </p><p>قسم المدفوعات المتكررة من <a href='%s'>اتفاقية مستخدم باي بال</a>.</p><p>للتأكد من إمكانية إجراء مدفوعات عبر حسابك على باي بال، قد يقوم هذا التطبيق بمحاكاة إجراء معاملة صغيرة على سبيل التجربة دون أن يتم تحويل أي مبالغ خلال هذه العملية.</p>");
    a.put(em.an, "خطأ داخلي");
    a.put(em.ao, "<p>بالضغط على الزر أدناه، أقرُّ بموافقتي على بنود <a href='%1$s'>اتفاقية مستخدم باي بال</a> كما أُقرُّ بالتزامي بالقوانين والتشريعات اليابانية بما في ذلك العقوبات المفروضة على المدفوعات الموجهة إلى كوريا الشمالية وإيران وفقاً <a href='%2$s'>لقانون النقد الأجنبي والتجارة الخارجية</a> وذلك من أجل إتمام هذه المعاملة.</p>");
    a.put(em.ap, "تسجيل الدخول");
    a.put(em.aq, "تسجيل الدخول مع باي بال");
    a.put(em.ar, "تسجيل الخروج");
    a.put(em.as, "تسجيل الخروج");
    a.put(em.at, "موافق");
    a.put(em.au, "كلمة المرور");
    a.put(em.av, "الدفع بعد التسليم");
    a.put(em.aw, "دفع بواسطة");
    a.put(em.ax, "دفع بواسطة البطاقة");
    a.put(em.ay, "رصيد باي بال");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "الهاتف");
    a.put(em.aB, "رمز التعريف الشخصي");
    a.put(em.aC, "طريقة الدفع المفضلة");
    a.put(em.aD, "باي بال يحمي <a href='%s'>خصوصيتك</a> ومعلوماتك المالية.");
    a.put(em.aE, "جارٍ المعالجة");
    a.put(em.aF, "تذكّر البطاقة");
    a.put(em.aG, "طلب تحويل أموال");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p> سيتم إطلاع التاجر على أي بيانات ذات أهمية للمعاملة.</p><p>لسحب موافقتك، سجِّل الدخول إلى موقع paypal.com، ثم انتقل إلى خيارات <strong>تسجيل الدخول مع باي بال</strong> تحت إعدادات <strong>الملف الشخصي</strong>، واحذف هذا التاجر من القائمة.</p><p>باي بال غير مسؤول عن أيّ إجراءات أو أخطاء تقع من جانب الشريك.</p>");
    a.put(em.aI, "حساب توفير");
    a.put(em.aJ, "إرسال أموال");
    a.put(em.aK, "لقد تعذر الاتصال بخوادم باي بال. يرجى إعادة المحاولة.");
    a.put(em.aL, "يُرجى إعادة تسجيل الدخول إلى باي بال.");
    a.put(em.aM, "انتهى توقيت الجلسة.");
    a.put(em.aN, "عنوان الشحن");
    a.put(em.aO, "حديث المعرفة بـ PayPal؟ تسجيل الاشتراك");
    a.put(em.aP, "أبقني مسجّل الدخول");
    a.put(em.aQ, "خطأ نظام (‎%s‎‏). يرجى إعادة المحاولة لاحقاً.");
    a.put(em.aR, "أعد المحاولة");
    a.put(em.aS, "تعذر تسجيل الدخول إذ تم تفعيل المصادقة الثنائية على حسابك.");
    a.put(em.aT, "كود الحماية");
    a.put(em.aU, "إرسال رسالة نصية إلى هاتفك. سيبقى الكود المكون من 6 أرقام الذي ستتلقاه صالحاً لمدة 5 دقائق.");
    a.put(em.aV, "جارٍ إرسال الرسالة النصية.");
    a.put(em.aW, "أدخل كود الحماية المكون من 6 أرقام");
    a.put(em.aX, "رقم جوالك");
    a.put(em.aY, "إرسال رسالة نصية");
    a.put(em.aZ, "أعد إرسال الرسالة النصية");
    a.put(em.ba, "تعذر تسجيل الدخول إذ تم تفعيل المصادقة الثنائية على حسابك. يُرجى زيارة موقع باي بال الإلكتروني لتفعيل مفتاح الحماية الخاص بك.");
    a.put(em.bb, "غير مسموح بإجراء مدفوعات من هذا الجهاز.");
    a.put(em.bc, "جهاز غير مفوض باستخدامه");
    a.put(em.bd, "غير مسموح بإجراء مدفوعات لهذا التاجر (هوية العميل غير صحيحة).");
    a.put(em.be, "بيانات التاجر غير صحيحة");
    a.put(em.bf, "لقد تعذرت معالجة مدفوعاتك. يرجى إعادة المحاولة.");
    a.put(em.bg, "مصدر تمويل غير معروف");
    a.put(em.bh, "عذراً");
    a.put(em.bi, "طلبك");
    a.put(em.bj, "مسح البطاقة؟");
    a.put(em.bk, "لم يفلح القبول");
    a.put(em.bl, "لم يفلح الاتصال");
    a.put(em.bm, "لم يفلح تسجيل الدخول");
    a.put(em.bn, "تسجيل الدخول بكلمة المرور");
    a.put(em.bo, "تسجيل الدخول برمز التعريف الشخصي");
    a.put(em.bp, "لحظة من فضلك…");
    a.put(em.bq, "لم يفلح إجراء الدفع");
    a.put(em.br, "مسح ضوئي");
    a.put(em.bs, "كود الحماية غير صحيح. يرجى إعادة المحاولة.");
    a.put(em.bt, "عَبْر");
    a.put(em.bu, "خطأ نظام. يرجى إعادة المحاولة لاحقاً.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.ga
