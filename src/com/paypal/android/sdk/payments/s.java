  ...
  extends Activity
{
  ...
  protected final void onCreate(Bundle paramBundle)
  {
    ...
    new ev(this).a();
    new eu(this).a();
    new et(this).a(Arrays.asList(new String[] { s.class.getName(), LoginActivity.class.getName(), FuturePaymentInfoActivity.class.getName(), h.class.getName() }));
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.payments.s
