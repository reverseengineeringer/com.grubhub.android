  ...
  implements fz
{
  ...
  public gd()
  {
    ...
    a.put(em.X, "Enable display of your funding options to allow you to make a choice.");
    a.put(em.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    ...
    a.put(em.aL, "Please log in again to PayPal.");
    ...
    a.put(em.bc, "Unauthorized Device");
    ...
    a.put(em.bg, "Unrecognized Source");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gd
