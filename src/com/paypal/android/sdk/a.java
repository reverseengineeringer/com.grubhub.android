  ...
  implements fz
{
  ...
  public a()
  {
    a.put(em.a, "Godta og betal");
    a.put(em.b, "og andre");
    a.put(em.c, "Godkjenner");
    a.put(em.d, "Tilbake");
    a.put(em.e, "Reserve");
    a.put(em.f, "Avbryt");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Endre betalingsmetode");
    a.put(em.x, "Brukskonto");
    a.put(em.y, "Kontrollerer denne enheten …");
    a.put(em.z, "Fjern kortopplysningene");
    a.put(em.A, "Bekreft");
    a.put(em.B, "Er du sikker på at du vil fjerne kortopplysningene dine?");
    a.put(em.C, "Belast kortet");
    a.put(em.D, "Er du sikker på at du vil logge av PayPal?");
    a.put(em.E, "Betal");
    a.put(em.F, "Godta");
    a.put(em.G, "Opprettelsesdato for kontoen");
    a.put(em.H, "Kontostatus");
    a.put(em.I, "Kontotype");
    a.put(em.J, "Adresse");
    a.put(em.K, "Aldersgruppe");
    a.put(em.L, "Fødselsdato");
    a.put(em.M, "E-postadresse");
    a.put(em.N, "Fullt navn");
    a.put(em.O, "Kjønn");
    a.put(em.P, "Språk");
    a.put(em.Q, "Norsk, Norge");
    a.put(em.R, "Telefon");
    a.put(em.S, "Tidssone");
    a.put(em.T, "Del følgende: %s.");
    a.put(em.U, "Bruk sømløs-kassen.");
    a.put(em.V, "%s ber om at du:");
    a.put(em.W, "Del <a href='%1$s'>betalingsmetodene</a> som er tilknyttet PayPal-kontoen din.");
    a.put(em.X, "Aktiver visning av betalingskilder slik at du kan velge en.");
    a.put(em.Y, "<a href='%1$s'>Godkjenn betalinger</a> for fremtidige kjøp hos %2$s via PayPal. Du ber PayPal om å betale alle summer som %3$s ber om.");
    a.put(em.Z, "Tillater at de legger til og administrerer et fordelskort i PayPal-lommeboken din.");
    a.put(em.aa, "Godtar %1$s sine <a href='%2$s'>retningslinjer for personvern</a> og <a href='%3$s'>brukeravtale</a>.");
    a.put(em.ab, "Gi vedkommende tillatelse til å <a href='%1$s'>be om penger</a> på dine vegne inntil du trekker tilbake tillatelsen.");
    a.put(em.ac, "Gi vedkommende tillatelse til å <a href='%1$s'>overføre penger</a> på dine vegne inntil du trekker tilbake tillatelsen.");
    a.put(em.ad, "Godta");
    a.put(em.ae, "E-postadresse");
    a.put(em.af, "Eksempeldata");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "Utløper");
    a.put(em.ai, "<h1><strong>Betalingsmetoder</strong></h1><p>PayPal deler kun hvilke av betalingsmetodene dine som er tilgjengelige for bruk.</p>");
    a.put(em.aj, "Har du glemt passordet?");
    a.put(em.ak, "Fra");
    a.put(em.al, "Hvordan vil du finansiere fremtidige betalinger til %1$s er?");
    a.put(em.am, "<h1><strong>Fremtidig betalingsavtale</strong></h1><p>Den standard betalingskilden din brukes til å utføre fremtidige PayPal-betalinger for denne forhandleren.</p><p>Hvis du vil avbryte denne avtalen, logger du på PayPal-kontoen, går til <strong>Profil</strong> &gt; <strong>Mine innstillinger</strong> &gt; <strong>Logg på med PayPal</strong> og fjerner denne forhandleren fra listen.</p><p>Regelmessig betaling-delen av <a href='%s'>PayPals brukeravtale</a> er gjeldende.</p><p>For å kontrollere at betalinger fungerer med PayPal-kontoen din, kan denne appen simulere en liten prøvetransaksjonen, men ingen penger overføres.</p>");
    a.put(em.an, "Intern feil");
    a.put(em.ao, "<p>Ved å klikke på knappen nedenfor, godtar jeg vilkårene i <a href='%1$s'>PayPals brukeravtale</a> og jeg erklærer samtidig at jeg overholder japanske lover og forskrifter, herunder sanksjonsbestemmelser om betalinger til Nord-Korea og Iran, i tråd med japansk <a href='%2$s'>lovgivning om handel med utenlandske produkter og valuta</a>, for å fullføre transaksjonen.</p>");
    a.put(em.ap, "Logg på");
    a.put(em.aq, "Logg på med PayPal");
    a.put(em.ar, "Logg ut");
    a.put(em.as, "Logg ut");
    a.put(em.at, "OK");
    a.put(em.au, "Passord");
    a.put(em.av, "Betal etter levering");
    a.put(em.aw, "Betal med");
    a.put(em.ax, "Betal med kort");
    a.put(em.ay, "PayPal-saldo");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Telefonnummer");
    a.put(em.aB, "PIN-kode");
    a.put(em.aC, "Foretrukket betalingsmetode");
    a.put(em.aD, "PayPal beskytter <a href='%s'>personvern</a>-opplysningene dine og den økonomiske informasjonen din.");
    a.put(em.aE, "Behandler");
    a.put(em.aF, "Husk kortet");
    a.put(em.aG, "Pengeforespørsel");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Alle relevante transaksjonsdetaljer deles med forhandleren.</p><p>Hvis du vil trekke tilbake tillatelsen din, logger du på paypal.com, går til <strong>Logg på med PayPal</strong>-alternativene under <strong>Profil</strong>-innstillingene og fjerner denne forhandleren.</p><p>PayPal er ikke ansvarlig for partnerens handlinger eller feil.</p>");
    a.put(em.aI, "Sparekonto");
    a.put(em.aJ, "Betal/overfør");
    a.put(em.aK, "Det var et kommunikasjonsproblem med PayPal-serverne. Prøv på nytt.");
    a.put(em.aL, "Logg deg på PayPal på nytt.");
    a.put(em.aM, "Økten er utløpt");
    a.put(em.aN, "Leveringsadresse");
    a.put(em.aO, "Ny på PayPal? Opprett konto");
    a.put(em.aP, "Forbli pålogget");
    a.put(em.aQ, "Systemfeil (%s). Prøv på nytt senere.");
    a.put(em.aR, "Prøv på nytt");
    a.put(em.aS, "Kan ikke logge på, fordi påloggingen til kontoen din har godkjenning med to faktorer.");
    a.put(em.aT, "Sikkerhetskode");
    a.put(em.aU, "Send en tekstmelding til telefonen din. Den 6-sifrede koden du mottar, er gyldig i 5 minutter.");
    a.put(em.aV, "Sender meldingen");
    a.put(em.aW, "Oppgi den 6-sifrede sikkerhetskoden");
    a.put(em.aX, "Ditt mobilnummer");
    a.put(em.aY, "Send melding");
    a.put(em.aZ, "Send meldingen på nytt");
    a.put(em.ba, "Kan ikke logge på, fordi påloggingen til kontoen din har godkjenning med to faktorer. Gå til PayPals nettsted for å aktivere sikkerhetsnøkkelen din.");
    a.put(em.bb, "Betaling fra denne enheten er ikke tillatt.");
    a.put(em.bc, "Uautorisert enhet");
    a.put(em.bd, "Betalinger til denne forhandleren er ikke tillatt (ugyldig bruker-id).");
    a.put(em.be, "Ugyldig forhandler");
    a.put(em.bf, "Det oppsto et problem ved behandlingen av betalingen. Prøv på nytt.");
    a.put(em.bg, "Ukjent betalingsmetode");
    a.put(em.bh, "Vi beklager");
    a.put(em.bi, "Din bestilling");
    a.put(em.bj, "Vil du fjerne kortet?");
    a.put(em.bk, "Godkjenningen mislyktes");
    a.put(em.bl, "Tilkobling mislykket");
    a.put(em.bm, "Pålogging mislyktes");
    a.put(em.bn, "Logg på med passord");
    a.put(em.bo, "Logg på med PIN");
    a.put(em.bp, "Et øyeblikk …");
    a.put(em.bq, "Betaling mislyktes");
    a.put(em.br, "Skann");
    a.put(em.bs, "Feil sikkerhetskode. Prøv på nytt.");
    a.put(em.bt, "via");
    a.put(em.bu, "Systemfeil. Prøv på nytt senere.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.a
