  ...
  extends dn
{
  ...
  public fs(ea paramea, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    super(paramInt1, paramea);
    c = paramBoolean;
    d = paramInt2;
  }
  ...
  protected final boolean c(dz paramdz)
  {
    return (c) && ((paramdz instanceof fl)) && (!((fl)paramdz).u());
  }
}

/* Location:
 * Qualified Name:     com.paypal.android.sdk.fs
