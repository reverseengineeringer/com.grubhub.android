  ...
  implements fz
{
  ...
  public gc()
  {
    a.put(em.a, "Zustimmen und zahlen");
    a.put(em.b, "und andere");
    a.put(em.c, "Authentifizierung");
    a.put(em.d, "Zurück");
    a.put(em.e, "Alternative");
    a.put(em.f, "Abbrechen");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Zahlungsmethode ändern");
    a.put(em.x, "Girokonto");
    a.put(em.y, "Gerät wird überprüft…");
    a.put(em.z, "Kreditkartendaten löschen");
    a.put(em.A, "Bestätigen");
    a.put(em.B, "Möchten Sie Ihre Kreditkartendaten wirklich löschen?");
    a.put(em.C, "Kreditkarte belasten");
    a.put(em.D, "Möchten Sie sich wirklich ausloggen?");
    a.put(em.E, "Zahlen");
    a.put(em.F, "Zustimmen");
    a.put(em.G, "Konto eröffnet am");
    a.put(em.H, "Kontostatus");
    a.put(em.I, "Kontotyp");
    a.put(em.J, "Adresse");
    a.put(em.K, "Altersgruppe");
    a.put(em.L, "Geburtsdatum");
    a.put(em.M, "E-Mail-Adresse");
    a.put(em.N, "Vollständiger Name");
    a.put(em.O, "Geschlecht");
    a.put(em.P, "Sprache");
    a.put(em.Q, "Ländereinstellung");
    a.put(em.R, "Telefon");
    a.put(em.S, "Zeitzone");
    a.put(em.T, "Folgende Informationen weitergeben: %s.");
    a.put(em.U, "PayPal Express verwenden.");
    a.put(em.V, "%s bittet um folgende Zustimmung:");
    a.put(em.W, "Sie genehmigen die Weitergabe von Informationen über die in Ihrem PayPal-Konto hinterlegten <a href='%1$s'>Zahlungsmethoden</a>.");
    a.put(em.X, "Zahlungsquellen anzeigen, damit Sie bei der Zahlung wählen können.");
    a.put(em.Y, "Sie <a href='%1$s'>autorisieren Abbuchungen für zukünftige PayPal-Zahlungen</a> bei %2$s. Sie weisen PayPal an, die von %3$s geforderten Beträge zu zahlen.");
    a.put(em.Z, "Sie stimmen zu, dass der Händler seine Kundenkarte Ihrer E-Börse hinzufügt und sie dort verwaltet.");
    a.put(em.aa, "Sie stimmen den <a href='%2$s'>Datenschutzgrundsätzen</a> und den <a href='%3$s'>Nutzungsbedingungen</a> von %1$s zu.");
    a.put(em.ab, "Sie gestatten dem Händler, bis auf Widerruf in Ihrem Namen <a href='%1$s'>Geld anzufordern</a>.");
    a.put(em.ac, "Sie gestatten dem Händler, bis auf Widerruf in Ihrem Namen <a href='%1$s'>Geld zu senden</a>.");
    a.put(em.ad, "Zustimmen");
    a.put(em.ae, "E-Mail-Adresse");
    a.put(em.af, "Beispieldaten");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "Gültig bis");
    a.put(em.ai, "<h1><strong>Zahlungsmethoden</strong></h1><p>PayPal gibt nur weiter, welche Zahlungsmethoden verfügbar sind.</p>");
    a.put(em.aj, "Passwort vergessen?");
    a.put(em.ak, "Von");
    a.put(em.al, "Wie möchten Sie Ihre weiteren Zahlungen an %1$s finanzieren?");
    a.put(em.am, "<h1><strong>Abbuchungsvereinbarung</strong></h1><p>Für zukünftige PayPal-Zahlungen bei diesem Händler wird Ihre Standardzahlungsquelle verwendet. </p><p>Um diese Vereinbarung zu kündigen, loggen Sie sich in Ihr PayPal-Konto ein, rufen Sie <strong>Mein Profil</strong> &gt; <strong>Einstellungen</strong> &gt; <strong>Login mit PayPal</strong> auf und entfernen diesen Händler von der Liste.</p><p>Es gelten die <a href='%s'>PayPal-Nutzungsbedingungen</a> für Zahlungen im Einzugsverfahren.</p><p>Damit wir künftig Zahlungen von Ihrem PayPal-Konto abbuchen können, führt diese App eventuell eine kleine Testtransaktion durch. Hierbei wird aber kein Geld abgebucht.</p>");
    a.put(em.an, "Interner Fehler");
    a.put(em.ao, "<p>Durch Klicken auf den Button unten stimme ich den <a href='%1$s'>PayPal-Nutzungsbedingungen</a> zu und bestätige, dass ich bei dieser Transaktion die japanischen Gesetze und Vorschriften einhalte, einschließlich Sanktionen hinsichtlich Zahlungen nach Nordkorea oder in den Iran gemäß dem <a href='%2$s'>Gesetz über Devisen und internationalen Handel</a>.</p>");
    a.put(em.ap, "Einloggen");
    a.put(em.aq, "Login mit PayPal");
    a.put(em.ar, "Ausloggen");
    a.put(em.as, "Ausloggen");
    a.put(em.at, "OK");
    a.put(em.au, "Passwort");
    a.put(em.av, "Abbuchung nach Warenerhalt");
    a.put(em.aw, "Zahlen mit");
    a.put(em.ax, "Mit Kreditkarte zahlen");
    a.put(em.ay, "PayPal-Guthaben");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Handynr.");
    a.put(em.aB, "PIN");
    a.put(em.aC, "Bevorzugte Zahlungsmethode");
    a.put(em.aD, "PayPal schützt Ihre <a href='%s'>Privatsphäre</a> und Ihre Finanzinformationen.");
    a.put(em.aE, "In Verarbeitung");
    a.put(em.aF, "Kreditkarte speichern");
    a.put(em.aG, "Geld anfordern");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Alle relevanten Transaktionsdetails werden an den Händler weitergegeben.</p><p>Wenn Sie Ihre Zustimmung widerrufen möchten, loggen Sie sich auf PayPal.com ein und klicken Sie unter <strong>Mein Profil</strong> auf “Einstellungen”. Anschließend klicken Sie auf <strong>Login mit PayPal</strong> und entfernen diesen Händler.</p><p>PayPal übernimmt keine Verantwortung für die Handlungen oder Fehler des Partners.</p>");
    a.put(em.aI, "Sparkonto");
    a.put(em.aJ, "Geld senden");
    a.put(em.aK, "Beim Datenaustausch mit den PayPal-Servern ist ein Problem aufgetreten. Bitte versuchen Sie es erneut.");
    a.put(em.aL, "Loggen Sie sich erneut bei PayPal ein.");
    a.put(em.aM, "Sitzung abgelaufen");
    a.put(em.aN, "Lieferadresse");
    a.put(em.aO, "Neu bei PayPal? Neu anmelden");
    a.put(em.aP, "Eingeloggt bleiben");
    a.put(em.aQ, "Systemfehler (%s). Bitte versuchen Sie es später noch einmal.");
    a.put(em.aR, "Erneut versuchen");
    a.put(em.aS, "Einloggen nicht möglich, da in Ihrem Konto die Zwei-Faktor-Authentifizierung aktiviert ist.");
    a.put(em.aT, "Sicherheitscode");
    a.put(em.aU, "Wir senden Ihnen eine SMS auf Ihr Handy. Diese enthält einen 6-stelligen Code, der fünf Minuten lang gültig ist.");
    a.put(em.aV, "SMS senden");
    a.put(em.aW, "6-stelligen Sicherheitscode eingeben");
    a.put(em.aX, "Ihre Handynummer");
    a.put(em.aY, "SMS senden");
    a.put(em.aZ, "SMS erneut senden");
    a.put(em.ba, "Einloggen nicht möglich, da in Ihrem Konto die Zwei-Faktor-Authentifizierung aktiviert ist. Aktivieren Sie über die PayPal-Website Ihren Sicherheitsschlüssel.");
    a.put(em.bb, "Mit diesem Gerät sind keine Zahlungen möglich.");
    a.put(em.bc, "Nicht autorisiertes Gerät");
    a.put(em.bd, "Zahlungen an diesen Händler sind nicht möglich (ungültige Client-ID).");
    a.put(em.be, "Ungültiger Händler");
    a.put(em.bf, "Bei der Verarbeitung Ihrer Zahlung ist ein Problem aufgetreten. Bitte versuchen Sie es erneut.");
    a.put(em.bg, "Nicht erkannte Zahlungsquelle");
    a.put(em.bh, "Fehler");
    a.put(em.bi, "Ihre Bestellung");
    a.put(em.bj, "Kreditkarte löschen?");
    a.put(em.bk, "Zustimmung fehlgeschlagen");
    a.put(em.bl, "Keine Verbindung");
    a.put(em.bm, "Login nicht erfolgreich");
    a.put(em.bn, "Mit Passwort einloggen");
    a.put(em.bo, "Mit PIN einloggen");
    a.put(em.bp, "Einen Moment…");
    a.put(em.bq, "Zahlung fehlgeschlagen.");
    a.put(em.br, "Fotografieren");
    a.put(em.bs, "Sicherheitscode falsch. Bitte versuchen Sie es erneut.");
    a.put(em.bt, "über");
    a.put(em.bu, "Systemfehler. Bitte versuchen Sie es später noch einmal.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gc
