  ...
  implements fz
{
  ...
  public ge()
  {
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Change Payment Method");
    a.put(em.x, "Cheque");
    a.put(em.y, "Checking this device…");
    a.put(em.z, "Clear card information");
    a.put(em.A, "Confirm");
    a.put(em.B, "Are you sure you want to clear your card information?");
    ...
    a.put(em.W, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
    ...
    a.put(em.Z, "Allow them to link and manage their loyalty card in your PayPal wallet.");
    ...
    a.put(em.aA, "Phone");
    a.put(em.aB, "PIN");
    a.put(em.aC, "Preferred Payment Method");
    ...
    a.put(em.aT, "Security Code");
    a.put(em.aU, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(em.aV, "Sending SMS");
    a.put(em.aW, "Enter the 6-digit security code");
    a.put(em.aX, "Your mobile number");
    a.put(em.aY, "Send SMS");
    a.put(em.aZ, "Send SMS Again");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.ge
