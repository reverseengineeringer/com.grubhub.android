  ...
  implements fz
{
  ...
  public i()
  {
    a.put(em.a, "ยอมรับและชำระเงิน");
    a.put(em.b, "และอื่นๆ");
    a.put(em.c, "กำลังตรวจสอบความถูกต้อง");
    a.put(em.d, "ย้อนกลับ");
    a.put(em.e, "สำรอง");
    a.put(em.f, "ยกเลิก");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "เปลี่ยนวิธีการชำระเงิน");
    a.put(em.x, "กระแสรายวัน");
    a.put(em.y, "กำลังตรวจสอบอุปกรณ์นี้…");
    a.put(em.z, "ลบข้อมูลบัตรทั้งหมด");
    a.put(em.A, "ยืนยัน");
    a.put(em.B, "คุณแน่ใจไหมคะว่าต้องการลบข้อมูลบัตรทั้งหมดออก");
    a.put(em.C, "ชาร์จการ์ด");
    a.put(em.D, "คุณแน่ใจไหมคะว่าต้องการออกจากระบบ PayPal");
    a.put(em.E, "ชำระเงิน");
    a.put(em.F, "ยอมรับ");
    a.put(em.G, "วันที่สร้างบัญชี");
    a.put(em.H, "สถานะบัญชี");
    a.put(em.I, "ประเภทบัญชี");
    a.put(em.J, "ที่อยู่");
    a.put(em.K, "ช่วงอายุ");
    a.put(em.L, "วันเดือนปีเกิด");
    a.put(em.M, "ที่อยู่อีเมล");
    a.put(em.N, "ชื่อเต็ม");
    a.put(em.O, "เพศ");
    a.put(em.P, "ภาษา");
    a.put(em.Q, "ประเทศ");
    a.put(em.R, "หมายเลขโทรศัพท์");
    a.put(em.S, "เขตเวลา");
    a.put(em.T, "เปิดเผยข้อมูลต่อไปนี้: %s");
    a.put(em.U, "ใช้การชำระเงินแบบไร้รอยต่อ");
    a.put(em.V, "%s ขอให้คุณ:");
    a.put(em.W, "เปิดเผย<a href='%1$s'>วิธีการชำระเงิน</a>ที่เชื่อมโยงอยู่กับบัญชี PayPal ของคุณ");
    a.put(em.X, "เปิดใช้งานการแสดงแหล่งเงิน เพื่อให้คุณสามารถเลือกได้");
    a.put(em.Y, "<a href='%1$s'>อนุญาตให้เรียกเก็บเงิน</a> สำหรับการซื้อสินค้า %2$s ในอนาคตที่ชำระด้วย PayPal คุณระบุให้ PayPal ชำระเงินทั้งหมดตามที่ %3$s ขอ");
    a.put(em.Z, "อนุญาตให้เพิ่มและจัดการบัตรตอบแทนลูกค้าสมาชิกในกระเป๋าสตางค์ PayPal ของคุณ");
    a.put(em.aa, "ยอมรับ <a href='%2$s'>นโยบายความเป็นส่วนตัว</a> และ <a href='%3$s'>สัญญาสำหรับผู้ใช้บริการ</a> ของ %1$s");
    a.put(em.ab, "อนุญาตให้บุคคลดังกล่าว<a href='%1$s'>เรียกเก็บเงิน</a>ในนามของคุณจนกว่าคุณจะเพิกถอนความยินยอม");
    a.put(em.ac, "อนุญาตให้บุคคลดังกล่าว<a href='%1$s'>ชำระเงิน</a>ในนามของคุณจนกว่าคุณจะเพิกถอนความยินยอม");
    a.put(em.ad, "ความยินยอม");
    a.put(em.ae, "อีเมล");
    a.put(em.af, "ข้อมูลจำลอง");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "หมดอายุ");
    a.put(em.ai, "<h1><strong>วิธีการชำระเงิน</strong></h1><p>PayPal จะเปิดเผยเพียงแค่ว่ามีวิธีการชำระเงินใดบ้างที่สามารถใช้ได้</p>");
    a.put(em.aj, "ลืมรหัสผ่าน");
    a.put(em.ak, "จาก");
    a.put(em.al, "คุณต้องการใช้แหล่งเงินใดชำระเงินให้แก่ %1$s ในอนาคต");
    a.put(em.am, "<h1><strong>ข้อตกลงการชำระเงินในอนาคต</strong></h1><p>ระบบจะใช้แหล่งเงินที่เป็นค่าดีฟอลต์ของคุณเพื่อชำระเงินด้วย PayPal จากผู้ค้ารายนี้ในอนาคต</p><p>ถ้าต้องการยกเลิกข้อตกลงนี้ ให้เข้าสู่บัญชี PayPal ของคุณ จากนั้นไปที่ <strong>‘ข้อมูลบัญชี‘</strong> &gt; <strong>‘การตั้งค่าของฉัน‘</strong> &gt; <strong>‘เข้าสู่ระบบด้วย PayPal‘</strong> แล้วลบผู้ค้ารายนี้ออกจากรายการ</p><p>หัวข้อ ‘การชำระเงินเป็นงวด‘ ใน<a href='%s'>สัญญาสำหรับผู้ใช้บริการของ PayPal</a> มีผลกับข้อตกลงนี้</p><p>แอปนี้อาจจำลองการทำรายการยอดเล็กๆ เพื่อเป็นการทดสอบโดยไม่มีการโอนเงินจริง เพื่อให้มั่นใจว่าบัญชี PayPal ของคุณสามารถชำระเงินได้ในอนาคต</p>");
    a.put(em.an, "ข้อผิดพลาดภายใน");
    a.put(em.ao, "<p>การคลิกที่ปุ่มด้านล่างนี้หมายความว่า ข้าพเจ้าตกลงยอมรับข้อกำหนดของ <a href='%1$s'>สัญญาสำหรับผู้ใช้บริการของ PayPal</a> และขอยืนยันว่าข้าพเจ้าปฏิบัติตามกฎหมายและข้อบังคับของญี่ปุ่น ซึ่งรวมถึงมาตรการห้ามไม่ให้มีการชำระเงินไปยังเกาหลีเหนือและอิหร่าน ซึ่งเป็นไปตาม <a href='%2$s'>กฎหมายว่าด้วยการแลกเปลี่ยนเงินตราต่างประเทศและการค้าต่างประเทศ</a> เพื่อทำรายการดังกล่าวให้เสร็จสมบูรณ์</p>");
    a.put(em.ap, "เข้าสู่ระบบ");
    a.put(em.aq, "เข้าสู่ระบบด้วย PayPal");
    a.put(em.ar, "ออกจากระบบ");
    a.put(em.as, "ออกจากระบบ");
    a.put(em.at, "ตกลง");
    a.put(em.au, "รหัสผ่าน");
    a.put(em.av, "ชำระเงินหลังจากได้รับสินค้า");
    a.put(em.aw, "ชำระเงินด้วย");
    a.put(em.ax, "ชำระเงินด้วยบัตร");
    a.put(em.ay, "ยอดคงเหลือในบัญชี PayPal");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "โทรศัพท์");
    a.put(em.aB, "PIN");
    a.put(em.aC, "วิธีการชำระเงินหลัก");
    a.put(em.aD, "PayPal ปกป้อง<a href='%s'>ความเป็นส่วนตัว</a>และข้อมูลทางการเงินของคุณ");
    a.put(em.aE, "กำลังดำเนินการ");
    a.put(em.aF, "จำบัตร");
    a.put(em.aG, "เรียกเก็บเงิน");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>เราจะเปิดเผยรายละเอียดการทำรายการใดๆ ก็ตามที่เกี่ยวข้องให้ผู้ค้าทราบ</p><p>ถ้าต้องการเพิกถอนความยินยอม ให้เข้าสู่ระบบที่ paypal.com แล้วไปที่ตัวเลือก <strong>‘เข้าสู่ระบบด้วย PayPal‘</strong> ใต้การตั้งค่า <strong>‘ข้อมูลบัญชี‘</strong> แล้วลบผู้ค้ารายนี้ออก</p><p>PayPal จะไม่รับผิดชอบต่อการดำเนินการหรือข้อผิดพลาดใดๆ ในส่วนของพันธมิตร</p>");
    a.put(em.aI, "ออมทรัพย์");
    a.put(em.aJ, "ชำระเงิน");
    a.put(em.aK, "เกิดปัญหาในการติดต่อกับเซิร์ฟเวอร์ของ PayPal โปรดลองอีกครั้ง");
    a.put(em.aL, "โปรดเข้าสู่ระบบ PayPal อีกครั้ง");
    a.put(em.aM, "เซสชันหมดเวลา");
    a.put(em.aN, "ที่อยู่สำหรับจัดส่ง");
    a.put(em.aO, "ถ้าไม่เคยใช้ PayPal มาก่อน สมัครสมาชิก");
    a.put(em.aP, "อยู่ในระบบต่อไป");
    a.put(em.aQ, "ระบบเกิดข้อผิดพลาด (%s) โปรดลองอีกครั้งในภายหลัง");
    a.put(em.aR, "โปรดลองอีกครั้ง");
    a.put(em.aS, "ไม่สามารถเข้าสู่ระบบได้เนื่องจากบัญชีของคุณเปิดใช้งานการรับรองความถูกต้องด้วยสองปัจจัยอยู่");
    a.put(em.aT, "รหัสความปลอดภัย");
    a.put(em.aU, "ส่งข้อความไปที่โทรศัพท์ของคุณ รหัส 6 หลักที่คุณได้รับจะใช้ได้เป็นเวลา 5 นาที");
    a.put(em.aV, "กำลังส่งข้อความ");
    a.put(em.aW, "โปรดป้อนรหัสความปลอดภัย 6 หลัก");
    a.put(em.aX, "หมายเลขโทรศัพท์มือถือของคุณ");
    a.put(em.aY, "ส่งข้อความ");
    a.put(em.aZ, "ส่งข้อความอีกครั้ง");
    a.put(em.ba, "ไม่สามารถเข้าสู่ระบบได้เนื่องจากบัญชีของคุณเปิดใช้งานการรับรองความถูกต้องด้วยสองปัจจัยอยู่ โปรดเข้าไปที่เว็บไซต์ PayPal เพื่อเปิดใช้รหัสลับความปลอดภัยค่ะ");
    a.put(em.bb, "ไม่อนุญาตให้ชำระเงินจากอุปกรณ์นี้");
    a.put(em.bc, "อุปกรณ์ไม่ได้รับอนุญาต");
    a.put(em.bd, "ไม่อนุญาตให้ชำระเงินให้ผู้ค้ารายนี้ (clientId ไม่ถูกต้อง)");
    a.put(em.be, "ผู้ค้าไม่ถูกต้อง");
    a.put(em.bf, "เกิดปัญหาขณะดำเนินการชำระเงินให้คุณ โปรดลองอีกครั้ง");
    a.put(em.bg, "ไม่ทราบแหล่งที่มา");
    a.put(em.bh, "ขออภัยค่ะ");
    a.put(em.bi, "คำสั่งซื้อของคุณ");
    a.put(em.bj, "ลบบัตรทั้งหมดหรือไม่");
    a.put(em.bk, "ขอความยินยอมไม่สำเร็จ");
    a.put(em.bl, "เชื่อมต่อไม่สำเร็จ");
    a.put(em.bm, "เข้าสู่ระบบไม่สำเร็จ");
    a.put(em.bn, "เข้าสู่ระบบด้วยรหัสผ่าน");
    a.put(em.bo, "เข้าสู่ระบบด้วย PIN");
    a.put(em.bp, "โปรดรอสักครู่…");
    a.put(em.bq, "ชำระเงินไม่สำเร็จ");
    a.put(em.br, "สแกน");
    a.put(em.bs, "รหัสความปลอดภัยไม่ถูกต้อง โปรดลองอีกครั้ง");
    a.put(em.bt, "ผ่าน");
    a.put(em.bu, "ระบบเกิดข้อผิดพลาด โปรดลองอีกครั้งในภายหลัง");
