  ...
  implements fz
{
  ...
  public gi()
  {
    a.put(em.a, "Valider et payer");
    a.put(em.b, "et autre(s)");
    a.put(em.c, "Authentification");
    a.put(em.d, "Retour");
    a.put(em.e, "Secondaire");
    a.put(em.f, "Annuler");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Modifier le mode de paiement");
    a.put(em.x, "Courant");
    a.put(em.y, "Vérification de l’appareil…");
    a.put(em.z, "Effacer les informations de carte");
    a.put(em.A, "Confirmer");
    a.put(em.B, "Souhaitez-vous vraiment effacer les informations relatives à votre carte ?");
    a.put(em.C, "Débiter la carte");
    a.put(em.D, "Souhaitez-vous vraiment vous déconnecter de PayPal ?");
    a.put(em.E, "Payer");
    a.put(em.F, "Accepter");
    a.put(em.G, "Date de création du compte");
    a.put(em.H, "État du compte");
    a.put(em.I, "Type de compte");
    a.put(em.J, "Adresse");
    a.put(em.K, "Tranche d’âge");
    a.put(em.L, "Date de naissance");
    a.put(em.M, "Adresse email");
    a.put(em.N, "Nom complet");
    a.put(em.O, "Sexe");
    a.put(em.P, "Langue");
    a.put(em.Q, "Pays");
    a.put(em.R, "Téléphone");
    a.put(em.S, "Fuseau horaire");
    a.put(em.T, "Partager les informations suivantes : %s.");
    a.put(em.U, "Utiliser le paiement simplifié.");
    a.put(em.V, "%s vous demande de :");
    a.put(em.W, "Partager les <a href='%1$s'>modes de paiement</a> liés à votre compte PayPal.");
    a.put(em.X, "Activer l’affichage de vos options d’approvisionnement pour vous permettre de faire votre choix.");
    a.put(em.Y, "<a href='%1$s'>Autoriser les débits</a> pour les futurs achats chez %2$s payés avec PayPal. Vous donnez pour instruction à PayPal de payer tous les montants demandés par %3$s.");
    a.put(em.Z, "L’autoriser à ajouter et à gérer sa carte de fidélité dans votre portefeuille.");
    a.put(em.aa, "Accepter le <a href='%2$s'>règlement sur le respect de la vie privée</a> et les <a href='%3$s'>conditions d’utilisation</a> de %1$s .");
    a.put(em.ab, "L’autoriser à <a href='%1$s'>demander de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(em.ac, "L’autoriser à <a href='%1$s'>envoyer de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(em.ad, "Accepter");
    a.put(em.ae, "Email");
    a.put(em.af, "Données d’exemple");
    a.put(em.ag, "Environnement de test");
    a.put(em.ah, "Date d’expiration");
    a.put(em.ai, "<h1><strong>Modes de paiement</strong></h1><p>PayPal communique uniquement vos modes de paiement disponibles.</p>");
    a.put(em.aj, "Mot de passe oublié ?");
    a.put(em.ak, "De");
    a.put(em.al, "Comment souhaitez-vous approvisionner les futurs paiements à %1$s ?");
    a.put(em.am, "<h1><strong>Autorisation pour les futurs paiements</strong></h1><p>Votre source d’approvisionnement par défaut sera utilisée pour payer les futurs paiements PayPal chez ce marchand.</p><p>Pour annuler cette autorisation, connectez-vous à votre compte PayPal et accédez à <strong>Préférences</strong> &gt; <strong>Mes paramètres</strong> &gt; <strong>Connexion avec PayPal</strong> et supprimez ce marchand de la liste.</p><p>L’article Paiement récurrent des <a href='%s'>Conditions d’utilisation de PayPal</a> s’appliquera.</p><p>Pour s’assurer que votre compte PayPal pourra être débité à l’avenir, cette application peut simuler une petite transaction test sans transfert d’argent.</p>");
    a.put(em.an, "Erreur interne");
    a.put(em.ao, "<p>En cliquant sur le bouton ci-dessous, j’accepte les <a href='%1$s'>Conditions d’utilisation de PayPal</a> et déclare être en conformité avec les lois et réglementations japonaises, notamment les sanctions liées aux paiements vers la Corée-du-Nord et l’Iran conformément au <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> pour effectuer cette transaction.</p>");
    a.put(em.ap, "Connexion");
    a.put(em.aq, "Connexion avec PayPal");
    a.put(em.ar, "Déconnexion");
    a.put(em.as, "Déconnexion");
    a.put(em.at, "OK");
    a.put(em.au, "Mot de passe");
    a.put(em.av, "Paiement après Livraison");
    a.put(em.aw, "Payer par");
    a.put(em.ax, "Payer par carte");
    a.put(em.ay, "Solde PayPal");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Téléphone");
    a.put(em.aB, "Code d’accès");
    a.put(em.aC, "Mode de paiement principal");
    a.put(em.aD, "PayPal garantit le <a href='%s'>respect de votre vie privée</a> et protège vos informations financières.");
    a.put(em.aE, "En cours de traitement");
    a.put(em.aF, "Mémoriser la carte");
    a.put(em.aG, "Demande d’argent");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Toute information pertinente relative à la transaction sera communiquée au marchand.</p><p>Pour annuler l’autorisation, connectez-vous à paypal.com, puis accédez à <strong>Connexion avec PayPal</strong> sous <strong>Préférences</strong> et supprimez ce marchand.</p><p>PayPal n’est pas responsable des actions ou erreurs imputables au partenaire.</p>");
    a.put(em.aI, "Épargne");
    a.put(em.aJ, "Envoi d’argent");
    a.put(em.aK, "Un problème est survenu lors de la communication avec les serveurs PayPal. Merci de recommencer.");
    a.put(em.aL, "Merci de vous reconnecter à PayPal.");
    a.put(em.aM, "La session a expiré");
    a.put(em.aN, "Adresse de livraison");
    a.put(em.aO, "Nouveau sur PayPal ? Ouvrir un compte");
    a.put(em.aP, "Rester connecté");
    a.put(em.aQ, "Erreur système (%s). Réessayez ultérieurement.");
    a.put(em.aR, "Réessayer");
    a.put(em.aS, "Nous ne pouvons pas vous connecter car votre compte fait l’objet d’une authentification à deux facteurs.");
    a.put(em.aT, "Code de sécurité");
    a.put(em.aU, "Envoyer un SMS à votre téléphone. Le code à six chiffres que vous recevez sera valide pendant cinq minutes.");
    a.put(em.aV, "Envoi du SMS");
    a.put(em.aW, "Saisissez le code de sécurité à six chiffres");
    a.put(em.aX, "Votre numéro de mobile");
    a.put(em.aY, "Envoyer un SMS");
    a.put(em.aZ, "Envoyer de nouveau un SMS");
    a.put(em.ba, "Nous ne pouvons pas vous connecter, car votre compte fait l’objet d’une authentification à deux facteurs. Rendez-vous sur le site PayPal pour activer votre clé de sécurité.");
    a.put(em.bb, "Vous ne pouvez pas effectuer de paiements à partir de cet appareil.");
    a.put(em.bc, "Appareil non autorisé");
    a.put(em.bd, "Les paiements à ce marchand ne sont pas autorisés (identifiant client incorrect).");
    a.put(em.be, "Marchand incorrect");
    a.put(em.bf, "Un problème est survenu lors du traitement de votre paiement. Réessayez.");
    a.put(em.bg, "Source non reconnue");
    a.put(em.bh, "Désolé");
    a.put(em.bi, "Votre commande");
    a.put(em.bj, "Effacer la carte ?");
    a.put(em.bk, "Échec de l’autorisation");
    a.put(em.bl, "Échec de la connexion");
    a.put(em.bm, "Échec de la connexion");
    a.put(em.bn, "Connexion par mot de passe");
    a.put(em.bo, "Connexion par code d’accès");
    a.put(em.bp, "Un instant…");
    a.put(em.bq, "Échec du paiement");
    a.put(em.br, "Scanner");
    a.put(em.bs, "Cryptogramme visuel incorrect. Réessayez.");
    a.put(em.bt, "Via");
    a.put(em.bu, "Erreur système. Réessayez ultérieurement.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gi
