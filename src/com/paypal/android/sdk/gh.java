  ...
  implements fz
{
  ...
  public gh()
  {
    a.put(em.a, "Aceptar y pagar");
    a.put(em.b, "y otro");
    a.put(em.c, "Autenticando");
    a.put(em.d, "Atrás");
    a.put(em.e, "Garantía");
    a.put(em.f, "Cancelar");
    ...
    a.put(em.v, "Visa");
    a.put(em.w, "Cambiar forma de pago");
    a.put(em.x, "Cheques");
    a.put(em.y, "Comprobando el dispositivo…");
    a.put(em.z, "Borrar los datos de la tarjeta");
    a.put(em.A, "Confirmar");
    a.put(em.B, "¿Seguro que desea borrar los datos de su tarjeta?");
    a.put(em.C, "Cargar en tarjeta");
    a.put(em.D, "¿Está seguro que desea cerrar la sesión de PayPal?");
    a.put(em.E, "Pagar");
    a.put(em.F, "Aceptar");
    a.put(em.G, "Fecha de apertura de la cuenta");
    a.put(em.H, "Estado de la cuenta");
    a.put(em.I, "Tipo de cuenta");
    a.put(em.J, "Dirección");
    a.put(em.K, "Rango de edad");
    a.put(em.L, "Fecha de nacimiento");
    a.put(em.M, "Dirección de correo electrónico");
    a.put(em.N, "Nombre completo");
    a.put(em.O, "Sexo");
    a.put(em.P, "Idioma");
    a.put(em.Q, "Configuración regional");
    a.put(em.R, "Teléfono");
    a.put(em.S, "Zona horaria");
    a.put(em.T, "Compartir lo siguiente: %s.");
    a.put(em.U, "Utilizar pago integrado");
    a.put(em.V, "%s le solicita que usted:");
    a.put(em.W, "Comparta las <a href='%1$s'>formas de pago</a> asociadas a su cuenta PayPal.");
    a.put(em.X, "Active la visualización de sus opciones de pago para que usted pueda elegir.");
    a.put(em.Y, "<a href='%1$s'>Autorizar cargos</a> correspondientes a futuras compras en %2$s pagadas con PayPal. Le instruye a PayPal de pagar todos los importes solicitados por %3$s.");
    a.put(em.Z, "Le permita agregar y administrar su tarjeta de lealtad en su cartera de PayPal.");
    a.put(em.aa, "Acepte la <a href='%2$s'>Política de privacidad</a> y las <a href='%3$s'>Condiciones de uso</a> de %1$s.");
    a.put(em.ab, "Le permita <a href='%1$s'>solicitar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(em.ac, "Le permita <a href='%1$s'>enviar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(em.ad, "Permiso");
    a.put(em.ae, "Correo electrónico");
    a.put(em.af, "Datos de prueba");
    a.put(em.ag, "Sandbox");
    a.put(em.ah, "Caduca");
    a.put(em.ai, "<h1><strong>Formas de pago</strong></h1><p>PayPal solo comparte las formas de pago que están disponibles para su utilización.</p>");
    a.put(em.aj, "¿Olvidó su contraseña?");
    a.put(em.ak, "De");
    a.put(em.al, "¿Cómo le gustaría respaldar sus pagos futuros %1$s?");
    a.put(em.am, "<h1><strong>Acuerdo de pago futuro</strong></h1><p>Su forma de pago predeterminada se utilizará para realizar futuros pagos con PayPal de este vendedor.</p><p>Para cancelar este acuerdo, inicie sesión en su cuenta PayPal, vaya a <strong>Perfil</strong> &gt; <strong>Mi configuración</strong> &gt; <strong>Iniciar sesión con PayPal</strong> y eliminar a este comercio de la lista.</p><p>Aplicará el artículo Pagos recurrentes de las <a href='%s'>Condiciones de uso de PayPal</a>.</p><p>Para asegurarse de que los pagos con tu cuenta PayPal funcionen correctamente, esta aplicación puede simular una pequeña transacción de prueba, pero no se transferirá dinero.</p>");
    a.put(em.an, "Error interno");
    a.put(em.ao, "<p>Al hacer clic en el botón a continuación, por el presente documento acepto los términos de las <a href='%1$s'>Condiciones de uso de PayPal</a> y declaro que cumplo las leyes y normas japonesas, incluidas las sanciones contra pagos a Corea del Norte e Irán de conformidad con la <a href='%2$s'>Ley de divisas y comercio exterior</a> para realizar la transacción.</p>");
    a.put(em.ap, "Iniciar sesión");
    a.put(em.aq, "Iniciar sesión con Paypal");
    a.put(em.ar, "Cerrar sesión");
    a.put(em.as, "Cerrar sesión");
    a.put(em.at, "Aceptar");
    a.put(em.au, "Contraseña");
    a.put(em.av, "Pagar después de la entrega");
    a.put(em.aw, "Pagar con");
    a.put(em.ax, "Pagar con tarjeta");
    a.put(em.ay, "Saldo de la cuenta PayPal");
    a.put(em.az, "PayPal Credit");
    a.put(em.aA, "Teléfono");
    a.put(em.aB, "NIP");
    a.put(em.aC, "Forma de pago preferida");
    a.put(em.aD, "PayPal protege su <a href='%s'>privacidad</a> e información financiera.");
    a.put(em.aE, "Proceso en curso");
    a.put(em.aF, "Recordar tarjeta");
    a.put(em.aG, "Solicitar pago");
    a.put(em.aH, "<h1><strong>%s</strong></h1><p>Todos los detalles relevantes de la transacción se compartirán con el comercio.</p><p>Para retirar el permiso, inicie sesión en paypal.com y luego vaya a las opciones <strong>Iniciar sesión con PayPal</strong> en la sección de configuración del <strong>Perfil</strong> y elimine a este comercio.</p><p>PayPal no se responsabiliza de ninguna acción o error cometido por el partner.</p>");
    a.put(em.aI, "Ahorros");
    a.put(em.aJ, "Enviar un pago");
    a.put(em.aK, "Se ha producido un problema en la comunicación con los servidores de PayPal. Inténtelo de nuevo.");
    a.put(em.aL, "Inicie sesión de nuevo en PayPal.");
    a.put(em.aM, "Sesión caducada");
    a.put(em.aN, "Dirección de envío");
    a.put(em.aO, "¿Nuevo usuario de PayPal? Registrarse");
    a.put(em.aP, "Mantener la sesión activa");
    a.put(em.aQ, "Error de sistema (%s). Inténtelo de nuevo más tarde.");
    a.put(em.aR, "Inténtelo de nuevo");
    a.put(em.aS, "No logra iniciar sesión, porque la autenticación de dos factores fue activada para su cuenta.");
    a.put(em.aT, "Código de seguridad");
    a.put(em.aU, "Envíe un mensaje de texto a su teléfono. El código de 6 dígitos que reciba será válido durante 5 minutos.");
    a.put(em.aV, "Enviando mensaje de texto");
    a.put(em.aW, "Ingrese el código de seguridad de 6 dígitos.");
    a.put(em.aX, "Su teléfono móvil");
    a.put(em.aY, "Enviar mensaje de texto");
    a.put(em.aZ, "Enviar mensaje de texto de nuevo");
    a.put(em.ba, "No es posible iniciar sesión porque se ha activado la autenticación de dos factores para la cuenta. Visite el sitio web de PayPal para activar su clave de seguridad.");
    a.put(em.bb, "No se permiten los pagos desde este dispositivo.");
    a.put(em.bc, "Dispositivo no autorizado");
    a.put(em.bd, "Los pagos a este comercio no se permiten (id. de cliente no válida).");
    a.put(em.be, "Comercio no válido");
    a.put(em.bf, "Hubo un problema al procesar su pago. Inténtelo de nuevo.");
    a.put(em.bg, "Origen no reconocido");
    a.put(em.bh, "Lo sentimos");
    a.put(em.bi, "Su pedido");
    a.put(em.bj, "¿Eliminar tarjeta?");
    a.put(em.bk, "Error en el permiso");
    a.put(em.bl, "Error de conexión");
    a.put(em.bm, "Error de inicio de sesión");
    a.put(em.bn, "Iniciar sesión con contraseña");
    a.put(em.bo, "Iniciar sesión con NIP");
    a.put(em.bp, "Un momento…");
    a.put(em.bq, "Error de pago");
    a.put(em.br, "Escanear");
    a.put(em.bs, "Código de seguridad incorrecto. Inténtelo de nuevo.");
    a.put(em.bt, "Vía");
    a.put(em.bu, "Error del sistema. Inténtelo de nuevo más tarde.");
...
/* Location:
 * Qualified Name:     com.paypal.android.sdk.gh
