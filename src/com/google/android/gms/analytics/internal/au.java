  ...
  implements aj<b>
{
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    a.f().zzd("Int xml configuration name not recognized", paramString);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    a.f().zzd("Bool xml configuration name not recognized", paramString);
  }
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    a.f().zzd("String xml configuration name not recognized", paramString1);
  }
}
