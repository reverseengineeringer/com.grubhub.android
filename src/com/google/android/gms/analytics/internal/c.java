...
public class c
{
  ...
  private static String a(s params, Object paramObject)
  {
    ...
    do
    {
      ...
      if (i > 256)
      {
        ...
        params.zzc("Hit param name is too long and will be trimmed", Integer.valueOf(i), localObject);
      }
  ...
  private String a(String paramString1, String paramString2)
  {
    ...
    {
      aq.b(bool, "Short param name required");
  ...
  private static String b(s params, Object paramObject)
  {
    ...
    for (paramObject = "";; paramObject = paramObject.toString())
    {
      ...
      if (i > 8192)
      {
        ...
        params.zzc("Hit param value is too long and will be trimmed", Integer.valueOf(i), localObject);
      }
