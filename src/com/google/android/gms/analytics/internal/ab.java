...
{
  ab(aa paramaa, Context paramContext, String paramString)
  {
  ...
  private boolean a(SQLiteDatabase paramSQLiteDatabase, String paramString)
  {
    ...
    //   67: astore_1
    //   68: aload_0
    //   69: getfield 10	com/google/android/gms/analytics/internal/ab:a	Lcom/google/android/gms/analytics/internal/aa;
    //   72: ldc 93
    //   74: aload_2
    //   75: aload 5
    //   77: invokevirtual 99	com/google/android/gms/analytics/internal/aa:zzc	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    //   80: aload 4
    //   82: ifnull +10 -> 92
    //   85: aload 4
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    {
      aa.a(a).a();
      a.zzaX("Opening the database failed, dropping the table and recreating it");
      Object localObject = aa.b(a);
      a.getContext().getDatabasePath((String)localObject).delete();
      try
      {
      ...
      {
        a.zze("Failed to open freshly created database", localSQLiteException2);
  ...
  {
    aq.a(paramSQLiteDatabase.getPath());
  }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(aa.i());
