...
public abstract class ch
  ...
  implements cg
{
  public static cg a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof cg))) {
      return (cg)localIInterface;
    }
    return new ci(paramIBinder);
  }
...
/* Location:
 * Qualified Name:     com.google.android.gms.maps.internal.ch
