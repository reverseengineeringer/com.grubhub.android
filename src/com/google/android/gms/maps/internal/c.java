  ...
  implements a
{
  ...
  public g a(float paramFloat1, float paramFloat2)
    throws RemoteException
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
  ...
  public g a(float paramFloat, int paramInt1, int paramInt2)
    throws RemoteException
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
  ...
  /* Error */
  public g a(com.google.android.gms.maps.model.CameraPosition paramCameraPosition)
    throws RemoteException
  {
    // Byte code:
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 71	com/google/android/gms/maps/model/CameraPosition:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	com/google/android/gms/maps/internal/c:a	Landroid/os/IBinder;
    //   33: bipush 7
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
  ...
  /* Error */
  public g a(com.google.android.gms.maps.model.LatLng paramLatLng)
    throws RemoteException
  {
    // Byte code:
    //   0: invokestatic 25	android/os/Parcel:obtain	()Landroid/os/Parcel;
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 75	com/google/android/gms/maps/model/LatLng:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	com/google/android/gms/maps/internal/c:a	Landroid/os/IBinder;
    //   33: bipush 8
    //   35: aload_2
  ...
  /* Error */
  public g a(com.google.android.gms.maps.model.LatLng paramLatLng, float paramFloat)
    throws RemoteException
  {
    // Byte code:
    //   0: invokestatic 25	android/os/Parcel:obtain	()Landroid/os/Parcel;
    ...
    //   25: aload_3
    //   26: iconst_0
    //   27: invokevirtual 75	com/google/android/gms/maps/model/LatLng:writeToParcel	(Landroid/os/Parcel;I)V
    //   30: aload_3
    //   31: fload_2
    //   32: invokevirtual 58	android/os/Parcel:writeFloat	(F)V
    //   35: aload_0
    //   36: getfield 15	com/google/android/gms/maps/internal/c:a	Landroid/os/IBinder;
    //   39: bipush 9
    //   41: aload_3
    //   42: aload 4
    //   44: iconst_0
    ...
    //   56: aload 4
    //   58: invokevirtual 44	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
    //   61: invokestatic 49	com/google/android/gms/c/h:a	(Landroid/os/IBinder;)Lcom/google/android/gms/c/g;
    //   64: astore_1
    //   65: aload 4
    ...
    //   76: aload_3
    //   77: iconst_0
    //   78: invokevirtual 64	android/os/Parcel:writeInt	(I)V
    //   81: goto -51 -> 30
    //   84: astore_1
    //   85: aload 4
  ...
  /* Error */
  public g a(com.google.android.gms.maps.model.LatLngBounds paramLatLngBounds, int paramInt)
    throws RemoteException
  {
    // Byte code:
    //   0: invokestatic 25	android/os/Parcel:obtain	()Landroid/os/Parcel;
    ...
    //   25: aload_3
    //   26: iconst_0
    //   27: invokevirtual 80	com/google/android/gms/maps/model/LatLngBounds:writeToParcel	(Landroid/os/Parcel;I)V
    //   30: aload_3
    //   31: iload_2
    //   32: invokevirtual 64	android/os/Parcel:writeInt	(I)V
    //   35: aload_0
    //   36: getfield 15	com/google/android/gms/maps/internal/c:a	Landroid/os/IBinder;
    //   39: bipush 10
    //   41: aload_3
  ...
  /* Error */
  public g a(com.google.android.gms.maps.model.LatLngBounds paramLatLngBounds, int paramInt1, int paramInt2, int paramInt3)
    throws RemoteException
  {
    // Byte code:
    //   0: invokestatic 25	android/os/Parcel:obtain	()Landroid/os/Parcel;
    ...
    //   28: aload 5
    //   30: iconst_0
    //   31: invokevirtual 80	com/google/android/gms/maps/model/LatLngBounds:writeToParcel	(Landroid/os/Parcel;I)V
    //   34: aload 5
    //   36: iload_2
    ...
    //   46: aload 5
    //   48: iload 4
    //   50: invokevirtual 64	android/os/Parcel:writeInt	(I)V
    //   53: aload_0
    //   54: getfield 15	com/google/android/gms/maps/internal/c:a	Landroid/os/IBinder;
    //   57: bipush 11
    //   59: aload 5
    //   61: aload 6
    //   63: iconst_0
    ...
    //   75: aload 6
    //   77: invokevirtual 44	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
    //   80: invokestatic 49	com/google/android/gms/c/h:a	(Landroid/os/IBinder;)Lcom/google/android/gms/c/g;
    //   83: astore_1
    //   84: aload 6
    ...
    //   96: aload 5
    //   98: iconst_0
    //   99: invokevirtual 64	android/os/Parcel:writeInt	(I)V
    //   102: goto -68 -> 34
    //   105: astore_1
    //   106: aload 6
