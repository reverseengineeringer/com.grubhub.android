  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ("com.google.android.c2dm.intent.REGISTRATION".equals(paramMessage.getAction())) {
      GoogleCloudMessaging.zza(a).add(paramMessage);
    }
    while (GoogleCloudMessaging.zza(a, paramMessage)) {
      return;
    }
    paramMessage.setPackage(GoogleCloudMessaging.zzb(a).getPackageName());
    GoogleCloudMessaging.zzb(a).sendBroadcast(paramMessage);
  }
}
