...
public class i
{
  ...
  {
    paramString = new File(new android.support.v4.content.a().a(b), paramString);
  ...
  KeyPair a(String paramString, long paramLong)
  {
    try
    {
      KeyPair localKeyPair = d.a();
      a.edit().putString(paramString + "|P|", a.a(localKeyPair.getPublic().getEncoded())).putString(paramString + "|K|", a.a(localKeyPair.getPrivate().getEncoded())).putString(paramString + "|S|" + "cre", Long.toString(paramLong)).commit();
      return localKeyPair;
    }
    finally
    {
...
/* Location:
 * Qualified Name:     com.google.android.gms.iid.i
