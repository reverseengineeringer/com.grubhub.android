  ...
  public void cancelRequest()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          localBatchedImageRequest = (ImageLoader.BatchedImageRequest)ImageLoader.access$300(this$0).get(mCacheKey);
          if (localBatchedImageRequest == null) {
            break;
          }
        } while (!localBatchedImageRequest.removeContainerAndCancelIfNecessary(this));
        ImageLoader.access$300(this$0).remove(mCacheKey);
        return;
        localBatchedImageRequest = (ImageLoader.BatchedImageRequest)ImageLoader.access$400(this$0).get(mCacheKey);
      } while (localBatchedImageRequest == null);
      localBatchedImageRequest.removeContainerAndCancelIfNecessary(this);
    } while (ImageLoader.BatchedImageRequest.access$500(localBatchedImageRequest).size() != 0);
    ImageLoader.access$400(this$0).remove(mCacheKey);
  }
