...
class VolleyLog$MarkerLog
{
  ...
  public void add(String paramString, long paramLong)
  {
    ...
    mMarkers.add(new VolleyLog.MarkerLog.Marker(paramString, paramLong, SystemClock.elapsedRealtime()));
  }
  ...
  public void finish(String paramString)
  {
    ...
    //   7: aload_0
    //   8: invokespecial 88	com/android/volley/VolleyLog$MarkerLog:getTotalDuration	()J
    //   11: lstore 4
    //   13: lload 4
    //   15: lconst_0
    //   16: lcmp
    ...
    //   47: iconst_0
    //   48: lload 4
    //   50: invokestatic 96	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   53: aastore
    //   54: dup
    //   55: iconst_1
    //   56: aload_1
    //   57: aastore
    //   58: invokestatic 99	com/android/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   61: aload_0
    ...
    //   89: astore 6
    //   91: aload 6
    //   93: getfield 51	com/android/volley/VolleyLog$MarkerLog$Marker:time	J
    //   96: lstore 4
    //   98: ldc 115
    //   100: iconst_3
    ...
    //   108: lload_2
    //   109: lsub
    //   110: invokestatic 96	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   113: aastore
    //   114: dup
    //   115: iconst_1
    //   116: aload 6
    //   118: getfield 118	com/android/volley/VolleyLog$MarkerLog$Marker:thread	J
    //   121: invokestatic 96	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   124: aastore
    //   125: dup
    //   126: iconst_2
    //   127: aload 6
    //   129: getfield 122	com/android/volley/VolleyLog$MarkerLog$Marker:name	Ljava/lang/String;
    //   132: aastore
    //   133: invokestatic 99	com/android/volley/VolleyLog:d	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   136: lload 4
    //   138: lstore_2
    //   139: goto -68 -> 71
    //   142: astore_1
