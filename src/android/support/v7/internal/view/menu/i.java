  ...
  implements android.support.v4.b.a.a
{
  ...
  private CopyOnWriteArrayList<WeakReference<w>> w = new CopyOnWriteArrayList();
  private m x;
  ...
  private boolean a(ac paramac, w paramw)
  {
    boolean bool = false;
    if (w.isEmpty()) {
      return false;
    ...
    if (paramw != null) {
      bool = paramw.a(paramac);
    }
    paramw = w.iterator();
    w localw;
    if (paramw.hasNext())
    {
      WeakReference localWeakReference = (WeakReference)paramw.next();
      localw = (w)localWeakReference.get();
      if (localw == null) {
  ...
  private void c(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      w localw = (w)localWeakReference.get();
      if (localw == null) {
        w.remove(localWeakReference);
      } else {
  ...
  {
    boolean bool = true;
    if ((paramBoolean) && (f.getConfiguration().keyboard != 1) && (f.getBoolean(c.abc_config_showMenuShortcutsWhenKeyboardPresent))) {}
  ...
  public void a(Bundle paramBundle)
  {
    ...
    for (Object localObject1 = null; i1 < i2; localObject1 = localObject3)
    {
      ...
      View localView = ao.a(localMenuItem);
  ...
  public void a(w paramw, Context paramContext)
  {
    w.add(new WeakReference(paramw));
    paramw.a(paramContext, this);
    o = true;
  }
  ...
  public boolean a(MenuItem paramMenuItem, w paramw, int paramInt)
  {
    boolean bool2 = false;
    ...
    do
    {
      ...
      if (!((m)localObject).hasSubMenu()) {
        ((m)localObject).a(new ac(e(), this, (m)localObject));
      }
      localObject = (ac)((m)localObject).getSubMenu();
      if (i1 != 0) {
        paramMenuItem.a((SubMenu)localObject);
      }
      bool2 = a((ac)localObject, paramw) | bool1;
      bool1 = bool2;
    } while (bool2);
    a(true);
    return bool2;
  ...
  public SubMenu addSubMenu(int paramInt1, int paramInt2, int paramInt3, CharSequence paramCharSequence)
  {
    ...
    ac localac = new ac(e, this, paramCharSequence);
    paramCharSequence.a(localac);
    return localac;
  }
    ...
    do
    {
      ...
      do
      {
        ...
        while (i1 < i2)
        {
          ...
          if (localMenuItem.hasSubMenu()) {
            ((ac)localMenuItem.getSubMenu()).b(paramBundle);
          }
          i1 += 1;
        }
