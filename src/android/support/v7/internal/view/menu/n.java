  ...
  implements MenuItem
{
  ...
  n(Context paramContext, b paramb)
  {
    super(paramContext, paramb);
  }
  
  o a(ActionProvider paramActionProvider)
  {
    return new o(this, a, paramActionProvider);
  }
  ...
  public View getActionView()
  {
    ...
    if ((localView2 instanceof p)) {
      localView1 = ((p)localView2).c();
    }
    return localView1;
  }
  ...
  public MenuItem setActionView(int paramInt)
  {
    ...
    if ((localView instanceof CollapsibleActionView)) {
      ((b)b).setActionView(new p(localView));
    }
    return this;
  }
  ...
  public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener paramOnActionExpandListener)
  {
    ...
    for (paramOnActionExpandListener = new q(this, paramOnActionExpandListener);; paramOnActionExpandListener = null)
    {
  ...
  public MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener paramOnMenuItemClickListener)
  {
    ...
    for (paramOnMenuItemClickListener = new r(this, paramOnMenuItemClickListener);; paramOnMenuItemClickListener = null)
    {
