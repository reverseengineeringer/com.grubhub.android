  ...
  implements DialogInterface.OnClickListener
{
  ...
  SpinnerCompat(final Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    bc localbc = bc.a(paramContext, paramAttributeSet, l.Spinner, paramInt1, 0);
    setBackgroundDrawable(localbc.a(l.Spinner_android_background));
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = localbc.a(l.Spinner_spinnerMode, 0);
    }
    switch (i)
    {
    }
    for (;;)
    {
      I = localbc.a(l.Spinner_android_gravity, 17);
      G.a(localbc.c(l.Spinner_prompt));
      J = localbc.a(l.Spinner_disableChildrenWhenDisabled, false);
      localbc.b();
      if (H != null)
      {
        G.a(H);
      ...
      G = new al(this, null);
      continue;
      paramContext = new an(this, paramContext, paramAttributeSet, paramInt1);
      E = localbc.e(l.Spinner_android_dropDownWidth, -2);
      paramContext.a(localbc.a(l.Spinner_android_popupBackground));
      G = paramContext;
      F = new q(this)
      {
        public o a()
  ...
  void a(r paramr)
  {
    super.setOnItemClickListener(paramr);
  }
  ...
  public void a(SpinnerAdapter paramSpinnerAdapter)
  {
    ...
    if (G != null)
    {
      G.a(new am(paramSpinnerAdapter));
      return;
    }
    H = new am(paramSpinnerAdapter);
  }
  ...
  public void setOnItemClickListener(r paramr)
  {
