  ...
  implements ed
{
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = bc.a(paramContext, paramAttributeSet, l.ActionMode, paramInt, 0);
    ...
    u = paramContext.f(l.ActionMode_closeItemLayout, android.support.v7.a.i.abc_action_mode_close_item_material);
    paramContext.b();
  }
  ...
  private h g()
  {
    bp.a(l, -l.getWidth() - l.getLayoutParams()).leftMargin);
    Object localObject = bp.j(l).b(0.0F);
    ((dq)localObject).a(200L);
    ((dq)localObject).a(this);
    ((dq)localObject).a(new DecelerateInterpolator());
    h localh = new h();
    ...
    if (c != null)
    {
      ...
      if (i > 0)
      {
        ...
        while (i1 >= 0)
        {
          ...
          bp.e((View)localObject, 0.0F);
          localObject = bp.j((View)localObject).d(1.0F);
          ((dq)localObject).a(300L);
          localh.a((dq)localObject);
          i1 -= 1;
          i += 1;
        }
  ...
  private h h()
  {
    dq localdq = bp.j(l).b(-l.getWidth() - l.getLayoutParams()).leftMargin);
    localdq.a(200L);
    localdq.a(this);
    localdq.a(new DecelerateInterpolator());
    h localh = new h();
    localh.a(localdq);
  ...
  public void a(final android.support.v7.b.a parama)
  {
    ...
    if (l == null)
    {
      ...
      addView(l);
      l.findViewById(g.action_mode_close_button).setOnClickListener(new View.OnClickListener()
      {
