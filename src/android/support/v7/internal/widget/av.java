...
public class av
{
  ...
  private static final aw c = new aw(6);
  ...
  {
    i = paramContext;
    j = new ba(paramContext.getResources(), this);
    k = new TypedValue();
  }
  ...
  private ColorStateList a()
  {
    if (l == null)
    {
      ...
      l = new ColorStateList(new int[][] { arrayOfInt, { 16842908 }, { 16843518 }, { 16842919 }, { 16842912 }, { 16842913 }, new int[0] }, new int[] { i3, i2, i2, i2, i2, i2, i1 });
    }
    return l;
  }
  ...
  {
    if (d(paramInt)) {
      return new av(paramContext).a(paramInt);
    }
  ...
  private ColorStateList b()
  {
    if (n == null)
    {
      ...
      n = new ColorStateList(new int[][] { arrayOfInt, { 16842912 }, new int[0] }, new int[] { i1, i2, i3 });
    }
    return n;
  }
  ...
  private ColorStateList c()
  {
    if (m == null)
    {
      ...
      m = new ColorStateList(new int[][] { { -16842910 }, { 16842912 }, new int[0] }, new int[] { i1, i2, i3 });
    }
    return m;
  }
  ...
  private ColorStateList d()
  {
    if (o == null)
    {
      ...
      o = new ColorStateList(new int[][] { { -16842910 }, { 16842919 }, arrayOfInt, new int[0] }, new int[] { i1, i2, i3, i4 });
    }
    return o;
  }
  ...
  {
    Drawable localDrawable = a.a(i, paramInt);
    Object localObject = localDrawable;
    if (localDrawable != null)
    {
      localObject = localDrawable.mutate();
      if (a(g, paramInt)) {
        localObject = new at((Drawable)localObject, a());
      }
    }
    else
    {
    ...
    if (paramInt == f.abc_switch_track_mtrl_alpha) {
      return new at((Drawable)localObject, b());
    }
    if (paramInt == f.abc_switch_thumb_material) {
      return new at((Drawable)localObject, c(), PorterDuff.Mode.MULTIPLY);
    }
    if (paramInt == f.abc_btn_default_mtrl_shape) {
      return new at((Drawable)localObject, d());
    }
    if (a(h, paramInt)) {
