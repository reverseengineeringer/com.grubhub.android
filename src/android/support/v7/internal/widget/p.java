...
public abstract class p<T extends Adapter>
  extends ViewGroup
{
  int A;
  int B = -1;
  ...
  p(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public final r getOnItemClickListener()
  {
    return s;
  }
  
  public final s getOnItemLongClickListener()
  {
    return t;
  }
  
  public final t getOnItemSelectedListener()
  {
    return r;
  }
  ...
  public void setOnItemLongClickListener(s params)
  {
    if (!isLongClickable()) {
  ...
  public void setOnItemSelectedListener(t paramt)
  {
    r = paramt;
  }
