  ...
  extends RatingBar
{
  ...
  {
    int j = 0;
    if ((paramDrawable instanceof z))
    {
      localObject = ((z)paramDrawable).a();
      if (localObject != null)
      {
        localObject = a((Drawable)localObject, paramBoolean);
        ((z)paramDrawable).a((Drawable)localObject);
      }
    }
    do
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      if (b != null) {
        setMeasuredDimension(bp.a(b.getWidth() * getNumStars(), paramInt1, 0), getMeasuredHeight());
      }
      return;
    }
    finally
