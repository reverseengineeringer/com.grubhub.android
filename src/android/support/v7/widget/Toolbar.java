  ...
  extends ViewGroup
{
  ...
  private int r;
  private int s;
  private final android.support.v7.internal.widget.ag t = new android.support.v7.internal.widget.ag();
  ...
  {
    this(paramContext, paramAttributeSet, android.support.v7.a.b.toolbarStyle);
  }
  
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(a(paramContext, paramAttributeSet, paramInt), paramAttributeSet, paramInt);
    paramContext = bc.a(getContext(), paramAttributeSet, android.support.v7.a.l.Toolbar, paramInt, 0);
    l = paramContext.f(android.support.v7.a.l.Toolbar_titleTextAppearance, 0);
    m = paramContext.f(android.support.v7.a.l.Toolbar_subtitleTextAppearance, 0);
    u = paramContext.b(android.support.v7.a.l.Toolbar_android_gravity, u);
    n = 48;
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_titleMargins, 0);
    s = paramInt;
    r = paramInt;
    q = paramInt;
    p = paramInt;
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_titleMarginStart, -1);
    if (paramInt >= 0) {
      p = paramInt;
    }
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_titleMarginEnd, -1);
    if (paramInt >= 0) {
      q = paramInt;
    }
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_titleMarginTop, -1);
    if (paramInt >= 0) {
      r = paramInt;
    }
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_titleMarginBottom, -1);
    if (paramInt >= 0) {
      s = paramInt;
    }
    o = paramContext.d(android.support.v7.a.l.Toolbar_maxButtonHeight, -1);
    paramInt = paramContext.c(android.support.v7.a.l.Toolbar_contentInsetStart, Integer.MIN_VALUE);
    int i1 = paramContext.c(android.support.v7.a.l.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
    int i2 = paramContext.d(android.support.v7.a.l.Toolbar_contentInsetLeft, 0);
    int i3 = paramContext.d(android.support.v7.a.l.Toolbar_contentInsetRight, 0);
    t.b(i2, i3);
    if ((paramInt != Integer.MIN_VALUE) || (i1 != Integer.MIN_VALUE)) {
      t.a(paramInt, i1);
    }
    g = paramContext.a(android.support.v7.a.l.Toolbar_collapseIcon);
    h = paramContext.b(android.support.v7.a.l.Toolbar_collapseContentDescription);
    paramAttributeSet = paramContext.b(android.support.v7.a.l.Toolbar_title);
    if (!TextUtils.isEmpty(paramAttributeSet)) {
      setTitle(paramAttributeSet);
    }
    paramAttributeSet = paramContext.b(android.support.v7.a.l.Toolbar_subtitle);
    if (!TextUtils.isEmpty(paramAttributeSet)) {
      setSubtitle(paramAttributeSet);
    }
    j = getContext();
    setPopupTheme(paramContext.f(android.support.v7.a.l.Toolbar_popupTheme, 0));
    paramAttributeSet = paramContext.a(android.support.v7.a.l.Toolbar_navigationIcon);
    if (paramAttributeSet != null) {
      setNavigationIcon(paramAttributeSet);
    }
    paramAttributeSet = paramContext.b(android.support.v7.a.l.Toolbar_navigationContentDescription);
    if (!TextUtils.isEmpty(paramAttributeSet)) {
      setNavigationContentDescription(paramAttributeSet);
    }
    L = paramContext.d(android.support.v7.a.l.Toolbar_android_minHeight, 0);
    paramContext.b();
    N = paramContext.c();
  }
  ...
  {
    af localaf = (af)paramView.getLayoutParams();
  ...
  private int a(List<View> paramList, int[] paramArrayOfInt)
  {
    ...
    while (i2 < i5)
    {
      ...
      af localaf = (af)paramArrayOfInt.getLayoutParams();
      i4 = leftMargin - i4;
      i3 = rightMargin - i3;
  ...
  {
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, android.support.v7.a.l.Toolbar, paramInt, 0);
    paramInt = localTypedArray.getResourceId(android.support.v7.a.l.Toolbar_theme, 0);
  ...
  private void a(List<View> paramList, int paramInt)
  {
    ...
    {
      i4 = getChildCount();
      i3 = android.support.v4.view.m.a(paramInt, bp.e(this));
      paramList.clear();
      paramInt = i2;
      if (i1 == 0) {
        break;
      ...
      while (paramInt >= 0)
      {
        ...
        localaf = (af)localView.getLayoutParams();
  ...
  {
    int i2 = bp.e(this);
    int i1 = android.support.v4.view.m.a(paramInt, i2) & 0x7;
    paramInt = i1;
    switch (i1)
    {
    case 2: 
  ...
  private void m()
  {
    if (e == null)
    {
      e = new ImageButton(getContext(), null, android.support.v7.a.b.toolbarNavigationButtonStyle);
      af localaf = i();
      a = (0x800003 | n & 0x70);
      e.setLayoutParams(localaf);
    }
  }
  ...
  private void n()
  {
    if (i == null)
    {
      i = new ImageButton(getContext(), null, android.support.v7.a.b.toolbarNavigationButtonStyle);
      i.setImageDrawable(g);
      i.setContentDescription(h);
      af localaf = i();
      a = (0x800003 | n & 0x70);
      b = 2;
      i.setLayoutParams(localaf);
  ...
  public af a(AttributeSet paramAttributeSet)
  {
    return new af(getContext(), paramAttributeSet);
  }
  
  protected af a(ViewGroup.LayoutParams paramLayoutParams)
  {
    if ((paramLayoutParams instanceof af)) {
      return new af((af)paramLayoutParams);
    }
    if ((paramLayoutParams instanceof android.support.v7.app.b)) {
      return new af((android.support.v7.app.b)paramLayoutParams);
    }
    if ((paramLayoutParams instanceof ViewGroup.MarginLayoutParams)) {
      return new af((ViewGroup.MarginLayoutParams)paramLayoutParams);
    }
    return new af(paramLayoutParams);
  }
  ...
  public void a(i parami, a parama)
  {
  ...
  {
    return (super.checkLayoutParams(paramLayoutParams)) && ((paramLayoutParams instanceof af));
  }
  ...
  {
    if (H == null) {}
    for (android.support.v7.internal.view.menu.m localm = null;; localm = H.b)
    {
      if (localm != null) {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          localObject1 = (af)c.getLayoutParams();
          paramInt1 = topMargin;
        ...
        if (bool)
        {
          localObject1 = (af)d.getLayoutParams();
          paramInt4 = topMargin;
        ...
        for (int i4 = bottomMargin + (paramInt4 + i2) + paramInt1;; i4 = paramInt1)
        {
          ...
          else
          {
            ...
            localObject2 = d;
            label475:
            localObject1 = (af)((View)localObject1).getLayoutParams();
            localObject2 = (af)((View)localObject2).getLayoutParams();
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      i3 = getPaddingTop();
      i4 = getPaddingBottom();
      i5 = bp.a(Math.max(i7 + i6 + (i5 + i8), getSuggestedMinimumWidth()), paramInt1, 0xFF000000 & i1);
      paramInt1 = bp.a(Math.max(i2 + (i3 + i4), getSuggestedMinimumHeight()), paramInt2, i1 << 16);
      if (p()) {
        paramInt1 = 0;
      }
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    {
      if ((a != 0) && (H != null) && (paramParcelable != null))
      {
        paramParcelable = paramParcelable.findItem(a);
        if (paramParcelable != null) {
          ao.b(paramParcelable);
        }
      }
      if (b) {
        o();
  ...
  public void onRtlPropertiesChanged(int paramInt)
  {
    ...
    android.support.v7.internal.widget.ag localag = t;
    if (paramInt == 1) {}
    for (;;)
    {
      localag.a(bool);
  ...
  public void setOnMenuItemClickListener(ag paramag)
  {
    D = paramag;
  }
