...
public class ActionMenuView
  extends m
  implements android.support.v7.internal.view.menu.k, y
{
      ...
      for (i1 = 1;; i1 = i2)
      {
        ...
        if (i9 == 1)
        {
          ...
          if ((i2 != 0) && (i5 == 2))
          {
            ...
            localObject = (j)getChildAt(i8).getLayoutParams();
            if (d) {
              break label512;
            }
            i9 = paramInt2;
  ...
  protected j a(ViewGroup.LayoutParams paramLayoutParams)
  {
    if (paramLayoutParams != null)
    {
      ...
      for (paramLayoutParams = new j((j)paramLayoutParams);; paramLayoutParams = new j(paramLayoutParams))
      {
        if (h <= 0) {
          h = 16;
        }
  ...
  public void a(x paramx, android.support.v7.internal.view.menu.j paramj)
  {
    g = paramx;
    h = paramj;
  }
  ...
  public android.support.v7.internal.view.menu.i d()
  {
    return a;
  }
  ...
  public Menu getMenu()
  {
    ...
    if (a == null)
    {
      ...
      a = new android.support.v7.internal.view.menu.i((Context)localObject);
      a.a(new k(this, null));
      f = new a((Context)localObject);
      f.c(true);
      locala = f;
      if (g == null) {
        break label110;
    ...
    label110:
    for (Object localObject = g;; localObject = new i(this, null))
    {
      locala.a((x)localObject);
      a.a(f, c);
      f.a(this);
      return a;
    }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (n < i1)
    {
      j localj = (j)getChildAt(n).getLayoutParams();
      rightMargin = 0;
      leftMargin = 0;
      n += 1;
    }
