  ...
  extends ViewGroup
{
  ...
  public m(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = bc.a(paramContext, paramAttributeSet, l.LinearLayoutCompat, paramInt, 0);
  ...
  private void c(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < paramInt1)
    {
      ...
      {
        n localn = (n)localView.getLayoutParams();
        if (width == -1)
        {
          int i3 = height;
  ...
  void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      int i13 = bf.a(i1, bp.g(localView));
      if ((i3 != 0) && (width == -1))
      {
        i3 = 1;
        label611:
      ...
      i11 = bp.a(Math.max(f, getSuggestedMinimumHeight()), paramInt2, 0);
      i7 = (0xFFFFFF & i11) - f;
          ...
          if (i7 < i15)
          {
            ...
            else
            {
              ...
              if ((height != 0) || (i17 != 1073741824))
              {
                ...
                i1 = bf.a(i1, bp.g(localView) & 0xFF00);
                i6 = i5 - i9;
                i5 = i1;
                f1 -= f2;
                i1 = i6;
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            setMeasuredDimension(bp.a(Math.max(i2 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), paramInt1, i1), i11);
            if (i8 != 0) {
              c(i15, paramInt2);
            }
            return;
  ...
  void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        switch (android.support.v4.view.m.a(paramInt3, bp.e(this)) & 0x7)
        {
        default: 
  ...
  public n b(AttributeSet paramAttributeSet)
  {
    return new n(getContext(), paramAttributeSet);
  }
  
  protected n b(ViewGroup.LayoutParams paramLayoutParams)
  {
    return new n(paramLayoutParams);
  }
  ...
  void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      int i14 = bf.a(i2, bp.g(localView));
      if (bool1)
      {
      ...
      for (i9 = Math.max(i3, Math.max(localObject[3], Math.max(localObject[0], Math.max(localObject[1], localObject[2]))) + Math.max(arrayOfInt[3], Math.max(arrayOfInt[0], Math.max(arrayOfInt[1], arrayOfInt[2]))));; i9 = i3)
      {
        ...
        i13 = bp.a(Math.max(f, getSuggestedMinimumWidth()), paramInt1, 0);
        i3 = (0xFFFFFF & i13) - f;
        ...
        for (;;)
        {
          ...
          if (f2 > 0.0F)
          {
            ...
            if ((width != 0) || (i18 != 1073741824))
            {
              ...
              i5 = bf.a(i5, bp.g(localView) & 0xFF000000);
              f1 -= f2;
              i4 = i8;
            }
          }
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                setMeasuredDimension(0xFF000000 & i1 | i13, bp.a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), paramInt2, i1 << 16));
                if (i7 != 0) {
                  d(i16, paramInt1);
                }
                return;
  ...
  void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int[] arrayOfInt1 = i;
    int[] arrayOfInt2 = j;
    switch (android.support.v4.view.m.a(paramInt2 & 0x800007, bp.e(this)))
    {
    default: 
  ...
  public void onInitializeAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    if (Build.VERSION.SDK_INT >= 14)
    {
      ...
      paramAccessibilityEvent.setClassName(m.class.getName());
    }
  }
  ...
  public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo paramAccessibilityNodeInfo)
  {
    if (Build.VERSION.SDK_INT >= 14)
    {
      ...
      paramAccessibilityNodeInfo.setClassName(m.class.getName());
    }
  }
