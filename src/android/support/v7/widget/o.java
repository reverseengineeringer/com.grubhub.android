...
public class o
{
  ...
  private final x v = new x(this, null);
  private final w w = new w(this, null);
  private final v x = new v(this, null);
  private final t y = new t(this, null);
  private Runnable z;
  ...
  public o(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    d = new android.support.v7.internal.widget.v(paramContext, paramAttributeSet, paramInt1);
    d.setInputMethodMode(1);
    D = h.a(c.getResources().getConfiguration().locale);
  }
  ...
  private int i()
  {
    ...
    if (f == null)
    {
      ...
      {
        bool = true;
        f = new p((Context)localObject2, bool);
        if (s != null) {
          f.setSelector(s);
        }
        f.setAdapter(e);
        ...
        f.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
          public void onItemSelected(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
          {
            ...
            {
              paramAnonymousAdapterView = o.a(o.this);
              if (paramAnonymousAdapterView != null) {
                p.a(paramAnonymousAdapterView, false);
              }
            }
          }
