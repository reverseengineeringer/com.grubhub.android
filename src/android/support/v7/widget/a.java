  ...
  implements k
{
  ...
  private View a(MenuItem paramMenuItem)
  {
    ...
    for (;;)
    {
      ...
      if ((localView instanceof z))
      {
        ...
        if (((z)localView).getItemData() == paramMenuItem) {
          break;
        }
      }
      i1 += 1;
  ...
  public void a(Context paramContext, android.support.v7.internal.view.menu.i parami)
  {
    ...
    paramContext = android.support.v7.internal.view.a.a(paramContext);
    if (!k) {
      j = paramContext.b();
    }
    if (!q) {
  ...
  public void a(m paramm, z paramz)
  {
    paramz.a(paramm, 0);
    paramm = (ActionMenuView)f;
    paramz = (ActionMenuItemView)paramz;
    paramz.setItemInvoker(paramm);
    if (y == null) {
      y = new c(this, null);
    }
    paramz.setPopupCallback(y);
  }
  ...
  public boolean a(ac paramac)
  {
    ...
    for (Object localObject = paramac; ((ac)localObject).s() != c; localObject = (ac)((ac)localObject).s()) {}
    View localView = a(((ac)localObject).getItem());
    localObject = localView;
    if (localView == null)
    {
      if (i == null) {
    ...
    h = paramac.getItem().getItemId();
    w = new b(this, b, paramac);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (localObject != null) {
      android.support.v7.internal.c.a.a((ViewGroup)localObject);
    }
    ...
    if (c != null)
    {
      ...
      while (i1 < i4)
      {
        j localj = ((m)((ArrayList)localObject).get(i1)).a();
        if (localj != null) {
          localj.a(this);
        }
        i1 += 1;
  ...
  public boolean c()
  {
    ...
    {
      x = new d(this, new f(this, b, c, i, true));
      ((View)f).post(x);
      super.a(null);
      return true;
    }
