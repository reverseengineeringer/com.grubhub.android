  ...
  implements View.OnTouchListener
{
  ...
  private boolean b(MotionEvent paramMotionEvent)
  {
    ...
    if ((localObject == null) || (!((o)localObject).b())) {}
    do
    {
      return false;
      localObject = o.a((o)localObject);
    } while ((localObject == null) || (!((p)localObject).isShown()));
    MotionEvent localMotionEvent = MotionEvent.obtainNoHistory(paramMotionEvent);
    b(localView, localMotionEvent);
    a((View)localObject, localMotionEvent);
    boolean bool2 = ((p)localObject).a(localMotionEvent, i);
