  ...
  implements bd, bf
{
  ...
  {
    paramInt = aw.a(paramMotionEvent, paramInt);
    if (paramInt < 0) {
      return -1.0F;
    }
    return aw.d(paramMotionEvent, paramInt);
  }
  ...
  private void b()
  {
    x = new d(getContext(), -328966, 20.0F);
    A = new ac(getContext(), this);
    A.b(-328966);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
      ...
      case 6: 
        for (;;)
        {
          ...
          if (r)
          {
            ...
            a(f1);
            continue;
            s = aw.b(paramMotionEvent, aw.b(paramMotionEvent));
            continue;
            a(paramMotionEvent);
          }
        }
    ...
    return false;
    float f1 = aw.d(paramMotionEvent, aw.a(paramMotionEvent, s));
    float f2 = p;
    r = false;
    b((f1 - f2) * 0.5F);
    s = -1;
  ...
  {
    if (((Build.VERSION.SDK_INT < 21) && ((d instanceof AbsListView))) || ((d != null) && (!bp.r(d)))) {
      return;
    }
  ...
  public void setOnRefreshListener(at paramat)
  {
    e = paramat;
  }
