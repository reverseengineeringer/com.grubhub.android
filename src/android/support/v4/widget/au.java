...
public class au
{
  ...
  private au(Context paramContext, ViewGroup paramViewGroup, av paramav)
  {
  ...
  public static au a(ViewGroup paramViewGroup, float paramFloat, av paramav)
  {
    paramViewGroup = a(paramViewGroup, paramav);
    b = ((int)(b * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static au a(ViewGroup paramViewGroup, av paramav)
  {
    return new au(paramViewGroup.getContext(), paramViewGroup, paramav);
  }
  ...
  private void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt3 != 0)
    {
      paramInt1 = r.clampViewPositionHorizontal(s, paramInt1, paramInt3);
    ...
    for (;;)
    {
      if (paramInt4 != 0)
      {
        paramInt2 = r.clampViewPositionVertical(s, paramInt2, paramInt4);
        s.offsetTopAndBottom(paramInt2 - i2);
      }
      for (;;)
      {
        if ((paramInt3 != 0) || (paramInt4 != 0)) {
          r.onViewPositionChanged(s, paramInt1, paramInt2, paramInt1 - i1, paramInt2 - i2);
        }
        return;
      }
    }
  ...
  {
    int i2 = aw.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = aw.b(paramMotionEvent, i1);
      float f1 = aw.c(paramMotionEvent, i1);
      float f2 = aw.d(paramMotionEvent, i1);
      f[i3] = f1;
      g[i3] = f2;
      i1 += 1;
    }
  ...
  private void h()
  {
    ...
    a(a(bk.a(l, c), n, m), a(bk.b(l, c), n, m));
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)bk.a(l, c), (int)bk.b(l, c));
  }
  
  public boolean a(MotionEvent paramMotionEvent)
  {
    int i2 = aw.a(paramMotionEvent);
            ...
            if ((d != null) && (e != null))
            {
              ...
              for (;;)
              {
                ...
                if (i1 < i3)
                {
                  ...
                  int i6 = (int)f3;
                  i6 = r.clampViewPositionHorizontal(localView, i6 + i5, (int)f3);
                  int i7 = localView.getTop();
                  int i8 = (int)f4;
                  i8 = r.clampViewPositionVertical(localView, i8 + i7, (int)f4);
    ...
    case 5: 
      do
      {
        do
        {
          ...
          r.onEdgeTouched(i2 & p, i1);
          return;
          i1 = aw.b(paramMotionEvent, i3);
          f1 = aw.c(paramMotionEvent, i3);
          f2 = aw.d(paramMotionEvent, i3);
          a(f1, f2, i1);
          if (a != 0) {
            break;
          }
