...
public class be
{
  ...
  {
    if ((a()) && (b != null)) {
      return dj.a(b, a, paramFloat1, paramFloat2);
    }
    return false;
  }
  ...
  {
    if ((a()) && (b != null)) {
      return dj.a(b, a, paramFloat1, paramFloat2, paramBoolean);
    }
    return false;
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (a())
    {
      ...
      {
        if (dj.a(localViewParent, localView, a, paramInt))
        {
          b = localViewParent;
          dj.b(localViewParent, localView, a, paramInt);
          return true;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      dj.a(b, a, paramInt1, paramInt2, paramInt3, paramInt4);
      if (paramArrayOfInt != null)
      {
        a.getLocationInWindow(paramArrayOfInt);
        paramArrayOfInt[0] -= j;
  ...
  public boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      arrayOfInt[0] = 0;
      arrayOfInt[1] = 0;
      dj.a(b, a, paramInt1, paramInt2, arrayOfInt);
      if (paramArrayOfInt2 != null)
      {
        a.getLocationInWindow(paramArrayOfInt2);
