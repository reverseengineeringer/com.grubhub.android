  ...
  extends ViewGroup
{
  ...
  private static final Comparator<da> c = new Comparator()
  {
    public int a(da paramAnonymousda1, da paramAnonymousda2)
    {
      return b - b;
    }
  };
  ...
  private int aj = 0;
  private int b;
  private final ArrayList<da> e = new ArrayList();
  ...
  private int a(int paramInt1, float paramFloat, int paramInt2, int paramInt3)
  {
    if ((Math.abs(paramInt3) > N) && (Math.abs(paramInt2) > L))
    {
      ...
      for (;;)
      {
        ...
        if (e.size() > 0)
        {
          da localda1 = (da)e.get(0);
          da localda2 = (da)e.get(e.size() - 1);
  ...
  private void a(da paramda1, int paramInt, da paramda2)
  {
    int i4 = h.b();
    ...
    else
    {
      for (;;)
      {
        ...
        for (paramda2 = (da)e.get(i2);; paramda2 = (da)e.get(i2))
        {
          i3 = i1;
          f3 = f1;
          if (i1 <= b) {
  ...
  {
    int i1 = aw.b(paramMotionEvent);
    if (aw.b(paramMotionEvent, i1) == J) {
      if (i1 != 0) {
        break label56;
      }
    }
    ...
    for (i1 = 1;; i1 = 0)
    {
      F = aw.c(paramMotionEvent, i1);
      J = aw.b(paramMotionEvent, i1);
      if (K != null) {
        K.clear();
      }
      return;
  ...
  private void b(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    if (W != null)
    {
      ...
      while (i1 < i2)
      {
        de localde = (de)W.get(i1);
        if (localde != null) {
          localde.a(paramInt1, paramFloat, paramInt2);
        }
        i1 += 1;
      }
    }
  ...
  private da j()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject2 = localda;
      }
      return (da)localObject2;
      f1 = 0.0F;
      break;
      f2 = 0.0F;
      break label36;
  ...
  da a(int paramInt1, int paramInt2)
  {
    da localda = new da();
    b = paramInt1;
  ...
  void a()
  {
    ...
    E = cj.a(localViewConfiguration);
    L = ((int)(400.0F * f1));
    M = localViewConfiguration.getScaledMaximumFlingVelocity();
    Q = new v(localContext);
    R = new v(localContext);
    N = ((int)(25.0F * f1));
    O = ((int)(2.0F * f1));
    C = ((int)(16.0F * f1));
    bp.a(this, new dc(this));
    if (bp.c(this) == 0) {
      bp.c(this, 1);
    }
  }
  ...
  void a(int paramInt)
  {
    ...
    for (int i2 = i1;; i2 = 2)
    {
      ...
      if (paramInt < e.size())
      {
        localObject1 = (da)e.get(paramInt);
        if (b >= i) {
          if (b != i) {
            break label1273;
          }
      ...
      for (;;)
      {
        ...
        for (Object localObject3 = a(i, paramInt);; localObject3 = localObject1)
        {
          ...
          for (float f2 = 0.0F;; f2 = getPaddingRight() / i9 + 2.0F)
          {
            ...
            a((da)localObject3, i3, (da)localObject2);
            localObject2 = h;
            paramInt = i;
            if (localObject3 == null) {
              break label1145;
            ...
            localObject1 = a;
            ((bi)localObject2).b(this, paramInt, localObject1);
            h.b(this);
            i1 = getChildCount();
            paramInt = 0;
            while (paramInt < i1)
            {
              ...
              localObject1 = (db)((View)localObject2).getLayoutParams();
              childIndex = paramInt;
          ...
          for (;;)
          {
            ...
            if ((localObject1 != null) && (i1 == b))
            {
              ...
              paramInt += 1;
              if (paramInt < e.size()) {}
              for (localObject1 = (da)e.get(paramInt);; localObject1 = null)
              {
                f1 += f3;
                break;
              }
  ...
  protected void a(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    if (V > 0)
    {
      ...
      while (i5 < i8)
      {
        ...
        db localdb = (db)localView.getLayoutParams();
        int i4;
        int i3;
        if (!isDecor)
        {
  ...
  protected boolean a(View paramView, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while ((paramBoolean) && (bp.a(paramView, -paramInt1)))
    {
      View localView;
      return true;
      i1 -= 1;
  ...
  public void addView(View paramView, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    ...
    for (;;)
    {
      db localdb = (db)paramLayoutParams;
      isDecor |= paramView instanceof cz;
      if (w)
      {
        if ((localdb != null) && (isDecor)) {
      ...
      else
      {
        if (b != i5)
        {
          ...
          if (i4 != 0)
          {
            ...
            while (i2 < i3)
            {
              localObject = (db)getChildAt(i2).getLayoutParams();
              if (!isDecor) {
                widthFactor = 0.0F;
              }
              i2 += 1;
  ...
  {
    return ((paramLayoutParams instanceof db)) && (super.checkLayoutParams(paramLayoutParams));
  }
  ...
  public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        da localda = a(localView);
        if ((localda != null) && (b == i) && (localView.dispatchPopulateAccessibilityEvent(paramAccessibilityEvent))) {
          return true;
        }
      }
      i1 += 1;
  ...
  {
    return new db(getContext(), paramAttributeSet);
  }
  ...
  protected int getChildDrawingOrder(int paramInt1, int paramInt2)
  {
    ...
    return ag.get(i1)).getLayoutParams()).childIndex;
  }
    ...
    for (;;)
    {
      ...
      if (i1 < i6)
      {
        while ((i1 > b) && (i2 < i5))
        {
          localObject = e;
          i2 += 1;
          localObject = (da)((ArrayList)localObject).get(i2);
        }
        if (i1 != b) {
          break label271;
        }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i1 != -1)
      {
        i1 = aw.a(paramMotionEvent, i1);
        float f2 = aw.c(paramMotionEvent, i1);
        float f1 = f2 - F;
        float f4 = Math.abs(f1);
        float f3 = aw.d(paramMotionEvent, i1);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (i4 < i6)
    {
      ...
      localdb = (db)localView.getLayoutParams();
      if (!isDecor) {
        break label671;
      }
      paramInt4 = gravity;
          ...
          if (!isDecor)
          {
            ...
            if (localda != null)
            {
              ...
              if (needsMeasure)
              {
                needsMeasure = false;
                f1 = i1;
                localView.measure(View.MeasureSpec.makeMeasureSpec((int)(widthFactor * f1), 1073741824), View.MeasureSpec.makeMeasureSpec(i7 - paramInt1 - paramInt3, 1073741824));
              }
      ...
      for (int i7 = i8;; i7 = paramInt2)
      {
        ...
        while (paramInt2 < i1)
        {
          ...
          if (localView.getVisibility() != 8)
          {
            ...
            {
              float f1 = paramInt1;
              localView.measure(View.MeasureSpec.makeMeasureSpec((int)(widthFactor * f1), 1073741824), v);
            }
          }
          paramInt2 += 1;
        }
  ...
  protected boolean onRequestFocusInDescendants(int paramInt, Rect paramRect)
  {
    ...
    while (i1 != i2)
    {
      ...
      {
        da localda = a(localView);
        if ((localda != null) && (b == i) && (localView.requestFocus(paramInt, paramRect)))
        {
          return true;
          i1 = i2 - 1;
          i2 = -1;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (!A)
      {
        i1 = aw.a(paramMotionEvent, J);
        f1 = aw.c(paramMotionEvent, i1);
        float f3 = Math.abs(f1 - F);
        f2 = aw.d(paramMotionEvent, i1);
      ...
      for (f1 = H + E;; f1 = H - E)
      {
        ...
        bool1 = false | b(aw.c(paramMotionEvent, aw.a(paramMotionEvent, J)));
        break;
      }
      boolean bool1 = i4;
      if (A)
      {
        ...
        int i2 = (int)bk.a((VelocityTracker)localObject, J);
        y = true;
        i4 = getClientWidth();
        int i5 = getScrollX();
        localObject = j();
        a(a(b, (i5 / i4 - e) / d, i2, (int)(aw.c(paramMotionEvent, aw.a(paramMotionEvent, J)) - H)), true, true, i2);
        J = -1;
        k();
        boolean bool3 = Q.c();
        ...
        if (A)
        {
          ...
          bool2 = R.c() | bool3;
          continue;
          int i3 = aw.b(paramMotionEvent);
          F = aw.c(paramMotionEvent, i3);
          J = aw.b(paramMotionEvent, i3);
          i3 = i4;
          continue;
          a(paramMotionEvent);
          F = aw.c(paramMotionEvent, aw.a(paramMotionEvent, J));
          i3 = i4;
        }
      }
    }
  ...
  public void setAdapter(bi parambi)
  {
    ...
    for (;;)
    {
      if ((ac != null) && (localObject != parambi)) {
        ac.a((bi)localObject, parambi);
      }
      return;
      label260:
      if (!bool) {
  ...
  void setOnAdapterChangeListener(dd paramdd)
  {
    ac = paramdd;
  }
  
  @Deprecated
  public void setOnPageChangeListener(de paramde)
  {
    aa = paramde;
  }
