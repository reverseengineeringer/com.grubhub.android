  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  dg mEnterTransitionCallback = null;
  Object mExitTransition = null;
  dg mExitTransitionCallback = null;
  int mFragmentId;
  z mFragmentManager;
  boolean mFromLayout;
  boolean mHasMenu;
  ...
  public static Fragment instantiate(Context paramContext, String paramString, Bundle paramBundle)
  {
    ...
    {
      throw new p("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an" + " empty constructor that is public", paramContext);
    }
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    y.a(paramBundle, mChildFragmentManager.w());
    return paramBundle;
  }
  ...
  void instantiateChildFragmentManager()
  {
    ...
    mChildFragmentManager.a(mHost, new t()
    {
  ...
  {
    mEnterTransitionCallback = paramdg;
  }
  ...
  {
    mExitTransitionCallback = paramdg;
  }
