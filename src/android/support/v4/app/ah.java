...
class ah
{
  ...
  private static void a(Transition paramTransition, ai paramai)
  {
    ...
    if (paramObject4 != null) {
      paramView1.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
      {
        public boolean onPreDraw()
        {
          ...
          if (paramObject1 != null) {
            ah.a(paramObject1, paramArrayList1);
          }
          if (paramObject2 != null) {
            ah.a(paramObject2, paramArrayList2);
          }
          if (paramObject3 != null) {
            ah.a(paramObject3, paramArrayList3);
          }
  ...
  public static void a(final Object paramObject1, Object paramObject2, View paramView1, final aj paramaj, final View paramView2, ai paramai, final Map<String, String> paramMap, final ArrayList<View> paramArrayList1, Map<String, View> paramMap1, final Map<String, View> paramMap2, ArrayList<View> paramArrayList2)
  {
    if ((paramObject1 != null) || (paramObject2 != null))
    {
      ...
      if (paramaj != null) {
        paramView1.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
        {
          public boolean onPreDraw()
          {
            ...
            View localView = paramaj.a();
            if (localView != null)
            {
              if (!paramMap.isEmpty())
              {
                ah.a(paramMap2, localView);
      ...
      a((Transition)paramObject1, paramai);
    }
  }
