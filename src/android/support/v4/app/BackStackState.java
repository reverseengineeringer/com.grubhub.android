  ...
  implements Parcelable
{
  ...
  public k a(z paramz)
  {
    ...
    while (m < a.length)
    {
      ...
      c = localObject[m];
      if (z.a) {
        Log.v("FragmentManager", "Instantiate " + localk + " op #" + i1 + " base fragment #" + a[n]);
      }
      localObject = a;
      m = n + 1;
      n = localObject[n];
      ...
      for (d = ((Fragment)f.get(n));; d = null)
      {
        ...
        for (;;)
        {
          ...
          if (z.a) {
            Log.v("FragmentManager", "Instantiate " + localk + " set remove fragment #" + a[n]);
          }
