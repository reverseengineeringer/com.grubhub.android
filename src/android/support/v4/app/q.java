  ...
  implements b, h
{
  ...
  boolean mCreated;
  final u mFragments = u.a(new r(this));
  ...
  {
    s locals = (s)getLastNonConfigurationInstance();
    if (locals != null) {
      return a;
    }
    return null;
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    {
      localu.a(localParcelable, paramBundle);
      mFragments.g();
      return;
    }
  }
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    l locall = mFragments.t();
    if ((localList == null) && (locall == null) && (localObject == null)) {
      return null;
    }
    s locals = new s();
    a = localObject;
