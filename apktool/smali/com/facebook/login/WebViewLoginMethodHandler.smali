...
# instance fields
.field private c:Lcom/facebook/internal/aq;
...
.method private b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/facebook/login/LoginClient;->b()Landroid/support/v4/app/q;
...
.method a(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;Lcom/facebook/h;)V
    ...
    .line 150
    invoke-static {v0, p2, v1, v3}, Lcom/facebook/login/WebViewLoginMethodHandler;->a(Ljava/util/Collection;Landroid/os/Bundle;Lcom/facebook/e;Ljava/lang/String;)Lcom/facebook/AccessToken;
    ...
    .line 163
    invoke-virtual {v3}, Lcom/facebook/login/LoginClient;->b()Landroid/support/v4/app/q;
    ...
    .line 183
    instance-of v1, p3, Lcom/facebook/p;
...
.method a(Lcom/facebook/login/LoginClient$Request;)Z
    ...
    invoke-static {v0}, Lcom/facebook/internal/al;->a(Ljava/util/Collection;)Z
    ...
    .line 88
    invoke-virtual {v0}, Lcom/facebook/login/a;->getNativeProtocolAudience()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/facebook/login/LoginClient;->b()Landroid/support/v4/app/q;
    ...
    invoke-direct {v3, v2, v4, v1}, Lcom/facebook/login/i;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V

    iget-object v1, p0, Lcom/facebook/login/WebViewLoginMethodHandler;->d:Ljava/lang/String;

    .line 125
    invoke-virtual {v3, v1}, Lcom/facebook/login/i;->a(Ljava/lang/String;)Lcom/facebook/login/i;
    ...
    invoke-virtual {v1, v3}, Lcom/facebook/login/i;->a(Z)Lcom/facebook/login/i;

    move-result-object v1

    .line 127
    invoke-virtual {v1, v0}, Lcom/facebook/login/i;->a(Lcom/facebook/internal/at;)Lcom/facebook/internal/ar;

    move-result-object v0

    .line 128
    invoke-static {}, Lcom/facebook/m;->l()I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/facebook/internal/ar;->a(I)Lcom/facebook/internal/ar;

    move-result-object v0

    .line 129
    invoke-virtual {v0}, Lcom/facebook/internal/ar;->a()Lcom/facebook/internal/aq;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/login/WebViewLoginMethodHandler;->c:Lcom/facebook/internal/aq;
    ...
    .line 133
    iget-object v1, p0, Lcom/facebook/login/WebViewLoginMethodHandler;->c:Lcom/facebook/internal/aq;

    invoke-virtual {v0, v1}, Lcom/facebook/internal/FacebookDialogFragment;->a(Landroid/app/Dialog;)V

    .line 134
    invoke-virtual {v2}, Landroid/support/v4/app/q;->getSupportFragmentManager()Landroid/support/v4/app/w;

    move-result-object v1

    const-string v2, "FacebookDialogFragment"

    invoke-virtual {v0, v1, v2}, Lcom/facebook/internal/FacebookDialogFragment;->show(Landroid/support/v4/app/w;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/facebook/internal/al;->b(Landroid/content/Context;)V
...
.method b()V
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lcom/facebook/login/WebViewLoginMethodHandler;->c:Lcom/facebook/internal/aq;
