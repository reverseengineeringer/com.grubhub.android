...
# direct methods
.method constructor <init>(Landroid/content/Context;Lcom/paypal/android/sdk/payments/l;)V
    .locals 9
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->d:Landroid/widget/ScrollView;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/m;->d:Landroid/widget/ScrollView;
    ...
    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->e:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/m;->e:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/payments/m;->e:Landroid/widget/LinearLayout;
    ...
    invoke-static {v2, v0, v1, v3, v4}, Lcom/paypal/android/sdk/ec;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0, v1}, Lcom/paypal/android/sdk/ec;->a(Landroid/view/View;II)V

    new-instance v0, Landroid/widget/ImageView;

    invoke-direct {v0, p1}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->f:Landroid/widget/ImageView;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/m;->f:Landroid/widget/ImageView;
    ...
    invoke-static {v1, p1}, Lcom/paypal/android/sdk/ec;->b(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v3}, Lcom/paypal/android/sdk/ec;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v0, v1, v3, v4, v5}, Lcom/paypal/android/sdk/ec;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->b:Landroid/widget/TextView;

    new-instance v3, Landroid/webkit/WebView;

    invoke-direct {v3, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    sget v0, Lcom/paypal/android/sdk/eb;->d:I

    invoke-virtual {v3, v0}, Landroid/webkit/WebView;->setBackgroundColor(I)V

    sget-boolean v0, Lcom/paypal/android/sdk/ek;->a:Z
    ...
    const-string v1, "} h1, strong { font-family: DroidSans, sans-serif; font-weight: 500; }"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, "h1 { font-size: 18px }h1, p { margin: 0 0 13px 0 }"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, "ul { margin: 0; padding-left: 1.1em; list-style-position: outside; }"
    ...
    sget-object v0, Lcom/paypal/android/sdk/payments/n;->a:[I

    invoke-virtual {p2}, Lcom/paypal/android/sdk/payments/l;->ordinal()I
    ...
    invoke-static {v3, v0, v1}, Lcom/paypal/android/sdk/ec;->a(Landroid/view/View;II)V
    ...
    invoke-static {v3, v0, v1, v4, v5}, Lcom/paypal/android/sdk/ec;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/Button;

    invoke-direct {v0, p1}, Landroid/widget/Button;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->c:Landroid/widget/Button;

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/m;->c:Landroid/widget/Button;
    ...
    invoke-static {v0, v1, p1}, Lcom/paypal/android/sdk/ec;->a(Landroid/view/View;ZLandroid/content/Context;)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/paypal/android/sdk/ec;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/payments/m;->d:Landroid/widget/ScrollView;

    iput-object v0, p0, Lcom/paypal/android/sdk/payments/m;->a:Landroid/view/View;
    ...
    :pswitch_1
    sget-object v0, Lcom/paypal/android/sdk/em;->ai:Lcom/paypal/android/sdk/em;
    ...
    :pswitch_2
    sget-object v0, Lcom/paypal/android/sdk/em;->aH:Lcom/paypal/android/sdk/em;
    ...
    sget-object v6, Lcom/paypal/android/sdk/em;->aG:Lcom/paypal/android/sdk/em;

    invoke-static {v6}, Lcom/paypal/android/sdk/ek;->a(Lcom/paypal/android/sdk/em;)Ljava/lang/String;
    ...
    sget-object v6, Lcom/paypal/android/sdk/em;->aJ:Lcom/paypal/android/sdk/em;
