...
.method a()V
    ...
    .line 258
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/ao;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/l;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;
    ...
    iget-object v2, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/l;->d()V
...
.method public a(Landroid/support/v4/content/l;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/ap;->b:Landroid/support/v4/e/m;
    ...
    .line 402
    :cond_4
    iput-object v4, p0, Landroid/support/v4/app/aq;->n:Landroid/support/v4/app/aq;

    .line 403
    iget-object v1, p0, Landroid/support/v4/app/aq;->o:Landroid/support/v4/app/ap;

    iget-object v1, v1, Landroid/support/v4/app/ap;->b:Landroid/support/v4/e/m;

    iget v2, p0, Landroid/support/v4/app/aq;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/e/m;->b(ILjava/lang/Object;)V

    .line 404
    invoke-virtual {p0}, Landroid/support/v4/app/aq;->g()V
...
.method public a(Landroid/support/v4/content/l;Ljava/lang/Object;)V
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/aq;->b(Landroid/support/v4/content/l;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/aq;->o:Landroid/support/v4/app/ap;

    iget-object v0, v0, Landroid/support/v4/app/ap;->c:Landroid/support/v4/e/m;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/e/m;->c(I)V

    .line 461
    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/aq;->o:Landroid/support/v4/app/ap;

    invoke-static {v0}, Landroid/support/v4/app/ap;->a(Landroid/support/v4/app/ap;)Landroid/support/v4/app/v;
...
.method b(Landroid/support/v4/content/l;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Landroid/support/v4/app/ap;->a(Landroid/support/v4/app/ap;)Landroid/support/v4/app/v;
    ...
    iget-object v1, v1, Landroid/support/v4/app/v;->d:Landroid/support/v4/app/z;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/content/l;->b(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/ao;->a(Landroid/support/v4/content/l;Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v2}, Landroid/support/v4/app/ap;->a(Landroid/support/v4/app/ap;)Landroid/support/v4/app/v;
    ...
    iget-object v2, v2, Landroid/support/v4/app/v;->d:Landroid/support/v4/app/z;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aq;->b(Landroid/support/v4/content/l;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/l;->b(Landroid/support/v4/content/m;)V

    .line 330
    iget-object v0, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;

    invoke-virtual {v0}, Landroid/support/v4/content/l;->h()V
...
.method f()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/l;->f()Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/aq;->a(Landroid/support/v4/content/l;)V
...
.method g()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;
    ...
    iget-object v3, p0, Landroid/support/v4/app/aq;->d:Landroid/support/v4/content/l;

    invoke-interface {v0, v3}, Landroid/support/v4/app/ao;->a(Landroid/support/v4/content/l;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/l;->l()V
