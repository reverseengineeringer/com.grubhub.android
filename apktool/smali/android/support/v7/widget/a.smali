...
.field private v:Landroid/support/v7/widget/f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/g;-><init>(Landroid/support/v7/widget/a;Landroid/support/v7/widget/a$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/a;->g:Landroid/support/v7/widget/g;

    .line 87
    return-void
.end method

.method static synthetic a(Landroid/support/v7/widget/a;Landroid/support/v7/widget/b;)Landroid/support/v7/widget/b;
    .locals 0

    .prologue
    .line 53
    iput-object p1, p0, Landroid/support/v7/widget/a;->w:Landroid/support/v7/widget/b;

    return-object p1
.end method

.method static synthetic a(Landroid/support/v7/widget/a;Landroid/support/v7/widget/d;)Landroid/support/v7/widget/d;
    .locals 0

    .prologue
    .line 53
    iput-object p1, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;

    return-object p1
.end method

.method static synthetic a(Landroid/support/v7/widget/a;)Landroid/support/v7/widget/f;
    .locals 1

    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/a;->v:Landroid/support/v7/widget/f;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/widget/a;Landroid/support/v7/widget/f;)Landroid/support/v7/widget/f;
    .locals 0

    .prologue
    .line 53
    iput-object p1, p0, Landroid/support/v7/widget/a;->v:Landroid/support/v7/widget/f;
...
.method private a(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    .line 282
    iget-object v0, p0, Landroid/support/v7/widget/a;->f:Landroid/support/v7/internal/view/menu/y;
    ...
    .line 288
    instance-of v1, v2, Landroid/support/v7/internal/view/menu/z;

    if-eqz v1, :cond_2

    move-object v1, v2

    check-cast v1, Landroid/support/v7/internal/view/menu/z;

    invoke-interface {v1}, Landroid/support/v7/internal/view/menu/z;->getItemData()Landroid/support/v7/internal/view/menu/m;
...
.method static synthetic b(Landroid/support/v7/widget/a;)Landroid/support/v7/widget/d;
    .locals 1

    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;
...
.method static synthetic e(Landroid/support/v7/widget/a;)Landroid/support/v7/internal/view/menu/y;
    .locals 1
...
.method static synthetic f(Landroid/support/v7/widget/a;)Landroid/support/v7/internal/view/menu/i;
    .locals 1
...
.method static synthetic g(Landroid/support/v7/widget/a;)Landroid/support/v7/internal/view/menu/y;
    .locals 1
...
.method static synthetic h(Landroid/support/v7/widget/a;)Landroid/support/v7/widget/b;
    .locals 1

    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/a;->w:Landroid/support/v7/widget/b;
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/y;
    .locals 2

    .prologue
    .line 161
    invoke-super {p0, p1}, Landroid/support/v7/internal/view/menu/d;->a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/y;
...
.method public a(Landroid/support/v7/internal/view/menu/m;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 177
    invoke-virtual {p3, v1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/j;
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v7/widget/e;-><init>(Landroid/support/v7/widget/a;Landroid/content/Context;)V
...
.method public a(Landroid/support/v7/internal/view/menu/m;Landroid/support/v7/internal/view/menu/z;)V
    .locals 2
    ...
    invoke-interface {p2, p1, v0}, Landroid/support/v7/internal/view/menu/z;->a(Landroid/support/v7/internal/view/menu/m;I)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/c;-><init>(Landroid/support/v7/widget/a;Landroid/support/v7/widget/a$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/a;->y:Landroid/support/v7/widget/c;
...
.method public a(Landroid/support/v7/widget/ActionMenuView;)V
    ...
    .prologue
    .line 548
    iput-object p1, p0, Landroid/support/v7/widget/a;->f:Landroid/support/v7/internal/view/menu/y;
...
.method public a(Z)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/internal/view/menu/d;->a(Landroid/support/v7/internal/view/menu/ac;)Z
...
.method public a(Landroid/support/v7/internal/view/menu/ac;)Z
    ...
    .line 264
    :goto_1
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/ac;->s()Landroid/view/Menu;
    ...
    .line 273
    :cond_3
    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/ac;->getItem()Landroid/view/MenuItem;
    ...
    invoke-direct {v1, p0, v2, p1}, Landroid/support/v7/widget/b;-><init>(Landroid/support/v7/widget/a;Landroid/content/Context;Landroid/support/v7/internal/view/menu/ac;)V

    iput-object v1, p0, Landroid/support/v7/widget/a;->w:Landroid/support/v7/widget/b;

    .line 275
    iget-object v1, p0, Landroid/support/v7/widget/a;->w:Landroid/support/v7/widget/b;
    ...
    .line 277
    invoke-super {p0, p1}, Landroid/support/v7/internal/view/menu/d;->a(Landroid/support/v7/internal/view/menu/ac;)Z
...
.method public b(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/m;->a()Landroid/support/v4/view/j;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/e;-><init>(Landroid/support/v7/widget/a;Landroid/content/Context;)V
    ...
    .line 240
    iget-object v1, p0, Landroid/support/v7/widget/a;->f:Landroid/support/v7/internal/view/menu/y;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->c()Landroid/support/v7/widget/j;
...
.method public b()Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/a;->f:Landroid/support/v7/internal/view/menu/y;
...
.method public c()Z
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/f;-><init>(Landroid/support/v7/widget/a;Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;Landroid/view/View;Z)V

    .line 304
    new-instance v1, Landroid/support/v7/widget/d;

    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/d;-><init>(Landroid/support/v7/widget/a;Landroid/support/v7/widget/f;)V

    iput-object v1, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;
...
.method public d()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->x:Landroid/support/v7/widget/d;
    ...
    .line 331
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/u;->e()V
