...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    .prologue
    .line 1904
    iput-object p1, p0, Landroid/support/v7/widget/ae;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/Toolbar$1;)V
    ...
    .prologue
    .line 1904
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ae;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V
    ...
    .prologue
    .line 1911
    iget-object v0, p0, Landroid/support/v7/widget/ae;->a:Landroid/support/v7/internal/view/menu/i;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ae;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ae;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/i;->d(Landroid/support/v7/internal/view/menu/m;)Z

    .line 1914
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/ae;->a:Landroid/support/v7/internal/view/menu/i;
...
.method public a(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
    ...
    .line 1966
    iget-object v0, p0, Landroid/support/v7/widget/ae;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ae;->c:Landroid/support/v7/widget/Toolbar;
    ...
    .line 1971
    iput-object p2, p0, Landroid/support/v7/widget/ae;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/af;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ae;->c:Landroid/support/v7/widget/Toolbar;
...
.method public b(Z)V
    ...
    .line 1928
    iget-object v1, p0, Landroid/support/v7/widget/ae;->a:Landroid/support/v7/internal/view/menu/i;
    ...
    .line 1931
    iget-object v3, p0, Landroid/support/v7/widget/ae;->a:Landroid/support/v7/internal/view/menu/i;
    ...
    .line 1932
    iget-object v4, p0, Landroid/support/v7/widget/ae;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/ae;->b(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
...
.method public b(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/internal/view/menu/m;)Z
    ...
    .line 2004
    iput-object v3, p0, Landroid/support/v7/widget/ae;->b:Landroid/support/v7/internal/view/menu/m;
