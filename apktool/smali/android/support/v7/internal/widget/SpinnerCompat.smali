...
.field private F:Landroid/support/v7/widget/q;

.field private G:Landroid/support/v7/internal/widget/ao;

.field private H:Landroid/support/v7/internal/widget/am;
...
.field private final L:Landroid/support/v7/internal/widget/av;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, v4}, Landroid/support/v7/internal/widget/bc;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/bc;
    ...
    .line 209
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ao;

    sget v2, Landroid/support/v7/a/l;->Spinner_prompt:I

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/bc;->c(I)Ljava/lang/String;
    ...
    .line 218
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/am;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/am;

    invoke-interface {v1, v2}, Landroid/support/v7/internal/widget/ao;->a(Landroid/widget/ListAdapter;)V

    .line 220
    iput-object v5, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/am;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->L:Landroid/support/v7/internal/widget/av;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v7/internal/widget/al;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/support/v7/internal/widget/SpinnerCompat$1;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ao;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v7/internal/widget/an;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v7/internal/widget/bc;->e(II)I
    ...
    invoke-direct {v2, p0, p0, v1}, Landroid/support/v7/internal/widget/SpinnerCompat$1;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/view/View;Landroid/support/v7/internal/widget/an;)V

    iput-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/q;
...
.method static synthetic a(Landroid/support/v7/internal/widget/SpinnerCompat;)Landroid/support/v7/internal/widget/ao;
    ...
    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ao;
...
.method a(IZ)V
    ...
    invoke-static {v5, v4}, Landroid/support/v4/view/m;->a(II)I
...
.method a(Landroid/support/v7/internal/widget/r;)V
    .locals 0

    .prologue
    .line 416
    invoke-super {p0, p1}, Landroid/support/v7/internal/widget/AbsSpinnerCompat;->setOnItemClickListener(Landroid/support/v7/internal/widget/r;)V
...
.method public a(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/am;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 421
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/q;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/q;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/q;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
