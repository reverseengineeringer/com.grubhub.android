...
# direct methods
.method static synthetic a(Landroid/support/v7/internal/widget/ActivityChooserView;)Landroid/support/v7/internal/widget/n;
    .locals 1

    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/n;
...
.method private a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/n;->d()Landroid/support/v7/internal/widget/h;
    ...
    .line 357
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/n;

    invoke-virtual {v3}, Landroid/support/v7/internal/widget/n;->c()I
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/internal/widget/n;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/internal/widget/n;->a(I)V

    .line 368
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/o;
    ...
    .line 371
    :cond_1
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/n;

    invoke-virtual {v2, v1, v0}, Landroid/support/v7/internal/widget/n;->a(ZZ)V
    ...
    .line 376
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/o;->d(I)V

    .line 377
    invoke-virtual {v3}, Landroid/support/v7/widget/o;->c()V
    ...
    .line 381
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/o;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/internal/widget/n;->a(Z)V

    .line 365
    iget-object v3, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/n;

    invoke-virtual {v3, p1}, Landroid/support/v7/internal/widget/n;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Landroid/support/v7/internal/widget/n;->a(ZZ)V
...
.method private getListPopupWindow()Landroid/support/v7/widget/o;
    .locals 2

    .prologue
    .line 505
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/o;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/o;

    .line 507
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/o;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->b:Landroid/support/v7/internal/widget/n;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/o;->a(Landroid/widget/ListAdapter;)V

    .line 508
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/o;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/o;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/o;->a(Z)V

    .line 510
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/o;

    iget-object v1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->c:Landroid/support/v7/internal/widget/o;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/o;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/o;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public getDataModel()Landroid/support/v7/internal/widget/h;
    .locals 1
...
.method public setActivityChooserModel(Landroid/support/v7/internal/widget/h;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/n;->a(Landroid/support/v7/internal/widget/h;)V
